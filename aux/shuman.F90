...
!
CALL PRINT_MSG(NVERB_FATAL, 'GEN', 'DXM', 'AROME SHOULD NOT CALLED HORIZONTAL FINITE DIFFERENCE')
!-------------------------------------------------------------------------------
!
...
!
CALL PRINT_MSG(NVERB_FATAL, 'GEN', 'DYF', 'AROME SHOULD NOT CALLED HORIZONTAL FINITE DIFFERENCE')
...
CALL PRINT_MSG(NVERB_FATAL, 'GEN', 'DYM', 'AROME SHOULD NOT CALLED HORIZONTAL FINITE DIFFERENCE')
!
!-------------------------------------------------------------------------------
!
