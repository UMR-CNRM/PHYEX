...
!              ------------
!
USE MODD_CST, ONLY: CST_ASSOCIATE, NDAYSEC, RDSCPD, RDSRV, RINVXP00, XALPHAOC, XALPI, XALPW, &
                    XAVOGADRO, XBETAI, XBETAOC, XBETAW, XBOLTZ, XCI, XCL, XCONDI, XCPD, XCPV, &
                    XDAY, XEPSILO, XEPS_DT, XESTT, XG, XGAMI, XGAMW, XI0, XKARMAN, XLIGHTSPEED, &
                    XLMTT, XLSTT, XLVTT, XMD, XMNH_EPSILON, XMNH_HUGE, XMNH_HUGE_12_LOG, &
                    XMNH_TINY, XMNH_TINY_12, XMV, XOMEGA, XP00, XP00OCEAN, XPI, XPLANCK, &
                    XRADIUS, XRD, XRES_FLAT_CART, XRES_OTHER, XRES_PREP, XRH00OCEAN, &
                    XRHOLI, XRHOLW, XRV, XSA00OCEAN, XSIDAY, XSIYEA, XSTEFAN, XTH00, XTH00OCEAN, XTT
