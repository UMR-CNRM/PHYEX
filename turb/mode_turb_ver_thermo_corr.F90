...
ENDDO
  ...
  ELSE
  DO JIJ=IIJB,IIJE 
    ZFLXZ(JIJ,IKB) = CSTURB%XCTV * PPHI3(JIJ,IKB+IKL) * PLM(JIJ,IKB)   &
    * PLEPS(JIJ,IKB)                                         &
    *( PEXPL *                                                  &
    ( ZCOEFF(JIJ,IKB+2*IKL)*PTHLM(JIJ,IKB+2*IKL)             &
    +ZCOEFF(JIJ,IKB+IKL)*PTHLM(JIJ,IKB+IKL)             & 
...
!
  ...
  ENDDO
    ...
    DO JIJ=IIJB,IIJE 
      ZFLXZ(JIJ,IKB) =                                                            & 
      (CSTURB%XCHT1 * PPHI3(JIJ,IKB+IKL) + CSTURB%XCHT2 * PPSI3(JIJ,IKB+IKL))   &
      *( PEXPL *                                                                              &
      ( ZCOEFF(JIJ,IKB+2*IKL)*PTHLM(JIJ,IKB+2*IKL)             &
      +ZCOEFF(JIJ,IKB+IKL)*PTHLM(JIJ,IKB+IKL)             & 
      +ZCOEFF(JIJ,IKB)*PTHLM(JIJ,IKB))                &
...
ENDIF
  ...
  ELSE
    DO JIJ=IIJB,IIJE 
      ZFLXZ(JIJ,IKB) = CSTURB%XCHV * PPSI3(JIJ,IKB+IKL) * PLM(JIJ,IKB)   &
      * PLEPS(JIJ,IKB)                                        &
      *( PEXPL *                                                  &
      ( ZCOEFF(JIJ,IKB+2*IKL)*PRM(JIJ,IKB+2*IKL,1)             &
      +ZCOEFF(JIJ,IKB+IKL)*PRM(JIJ,IKB+IKL,1)             & 
