...
IMPLICIT NONE
CONTAINS
SUBROUTINE TM06(D,TURBN,CST,PTHVREF,PBL_DEPTH,PZZ,PSFTH,PMWTH,PMTH2)
...
REAL, DIMENSION(MERGE(D%NIJT,0,TURBN%CTOM=='TM06')), INTENT(IN) :: PBL_DEPTH ! boundary layer height
