...
IMPLICIT NONE
!
! Index indicators for turbulence SPP
INTEGER, PARAMETER :: NCTP=1
INTEGER, PARAMETER :: NCTV=2
INTEGER, PARAMETER :: NCSHF=3
INTEGER, PARAMETER :: NCEP=4
INTEGER, PARAMETER :: NCED=5
INTEGER, PARAMETER :: NCMFS=6
INTEGER, PARAMETER :: NBL89EXP=7
INTEGER, PARAMETER :: NUSRBL89=8
INTEGER, PARAMETER :: NTURB_S=9
