...
DO JK=1,IKT
  DO JIJ=IIJB, IIJE
    ZL(JIJ, JK) =  CST%XKARMAN/SQRT(CSTURB%XALPSBL)/PTURB_SPP(JIJ,TURBN%ZCMFS)                                      &
...
DO JK=1, IKT
  DO JIJ=IIJB, IIJE
    ZL(JIJ, JK) = ZL(JIJ, JK) * (CSTURB%XALPSBL**(3./2.)*CST%XKARMAN*PTURB_SPP(JIJ,TURBN%ZCSHF)) &
            / (CST%XKARMAN/SQRT(CSTURB%XALPSBL)/PTURB_SPP(JIJ,TURBN%ZCMFS))
  END DO
END DO
!
DO JK=1, IKT
