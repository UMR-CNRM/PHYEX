...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
ZSHUGRADWK3_2D(:, :) = TURBN%XIMPL*ZRES(:, :) + PEXPL*PUM(:, :)
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
...
!$mnh_expand_array(JIJ=IIJB:IIJE)
ZSHUGRADWK1_1D(:) = ZFLXZ(:,IKE-IKL) * (TURBN%XIMPL*(ZRES(:,IKE)-ZRES(:,IKE-IKL)) + &
                                        PEXPL*(PUM(:,IKE)-PUM(:,IKE-IKL)))/ ZMXM1D_WORK1(:)
!$mnh_end_expand_array(JIJ=IIJB:IIJE)
...
!$mnh_expand_array(JIJ=IIJB:IIJE)
ZSHUGRADWK1_1D(:) = ZFLXZ(:,IKB+IKL) * (TURBN%XIMPL*(ZRES(:,IKB+IKL)-ZRES(:,IKB)) + &
                                        PEXPL*(PUM(:,IKB+IKL)-PUM(:,IKB)))/ ZMXM1D_WORK1(:)
!$mnh_end_expand_array(JIJ=IIJB:IIJE)
...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
ZSHUGRADWK2_2D(:, :) = ZGZ_U_UW2D_WORK1(:, :) *ZFLXZ(:, :)
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
ZSHUGRADWK1_2D(:, :) = ZGX_M_U2D_WORK1(:, :)* ZMZF2D_WORK1(:, :)
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
ZSHUGRADWK3_2D(:, :) = TURBN%XIMPL*ZRES(:, :) + PEXPL*PVM(:, :)
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
...
!$mnh_expand_array(JIJ=IIJB:IIJE)
ZSHUGRADWK1_1D(:) = ZFLXZ(:,IKE-IKL) * (TURBN%XIMPL*(ZRES(:,IKE)-ZRES(:,IKE-IKL)) + &
                                       PEXPL*(PVM(:,IKE)-PVM(:,IKE-IKL)))/ ZMYM1D_WORK1(:)
!$mnh_end_expand_array(JIJ=IIJB:IIJE)
...
!$mnh_expand_array(JIJ=IIJB:IIJE)
ZSHUGRADWK1_1D(:) = ZFLXZ(:,IKB+IKL) * (TURBN%XIMPL*(ZRES(:,IKB+IKL)-ZRES(:,IKB)) + &
                                       PEXPL*(PVM(:,IKB+IKL)-PVM(:,IKB)))/ ZMYM1D_WORK1(:)
!$mnh_end_expand_array(JIJ=IIJB:IIJE)
...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
ZSHUGRADWK2_2D(:, :) = ZGZ_V_VW2D_WORK1(:, :)*ZFLXZ(:, :)
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
ZSHUGRADWK1_2D(:, :) = ZGY_M_V2D_WORK1(:, :)*ZMZF2D_WORK1(:, :)
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
