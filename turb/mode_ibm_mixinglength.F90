...
SUBROUTINE IBM_MIXINGLENGTH(D,PLM,PLEPS,PMU,PHI,PTKE)
  ...
  REAL, DIMENSION(D%NIJT,D%NKT), INTENT(INOUT) :: PLM
  REAL, DIMENSION(D%NIJT,D%NKT), INTENT(INOUT) :: PLEPS
  REAL, DIMENSION(D%NIJT,D%NKT), INTENT(OUT)   :: PMU
  REAL, DIMENSION(D%NIJT,D%NKT), INTENT(IN)    :: PHI
