...
DO JK=1, IKT
  DO JIJ=IIJB, IIJE
    ZFLX(JIJ, JK) = PTURB_SPP(JIJ,NCSHF) * SQRT(PTKEM(JIJ, JK)) / PLEPS(JIJ, JK)
...
IF (BUCONF%LBUDGET_TKE) THEN
  ...
  DO JK=1, IKT
    DO JIJ=IIJB, IIJE
      ZMWORK1(JIJ, JK) = -PTURB_SPP(JIJ,NCSHF) * SQRT(PTKEM(JIJ, JK))/PLEPS(JIJ, JK) * &
  ...
  DO JIJ=IIJB, IIJE
    PRTKES(JIJ, JK) = PRTKES(JIJ, JK) + PRHODJ(JIJ, JK) * &
                    ( PDP(JIJ, JK) + PTP(JIJ, JK)                           &
                      - PTURB_SPP(JIJ,NCSHF) * SQRT(PTKEM(JIJ, JK)) / PLEPS(JIJ, JK) &
                      * ( PEXPL*PTKEM(JIJ, JK) + TURBN%XIMPL*ZRES(JIJ, JK) ) )
    !
...
IF(PRESENT(PDISS)) THEN
  ...
  DO JK=1, IKT
    DO JIJ=IIJB, IIJE
      PDISS(JIJ, JK) =  -PTURB_SPP(JIJ,NCSHF) * (PTKEM(JIJ, JK)**1.5) / PLEPS(JIJ, JK)
    END DO
  END DO
...
IF(PRESENT(PEDR)) THEN
  ...
  DO JK=1, IKT
    DO JIJ=IIJB, IIJE
      PEDR(JIJ, JK) = PTURB_SPP(JIJ,NCSHF) * (PTKEM(JIJ, JK)**1.5) / PLEPS(JIJ, JK)
    END DO
  END DO
