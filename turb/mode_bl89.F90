...
USE MODD_TURB_n, ONLY: TURB_t, NBL89EXP, NUSRBL89, NTURB_S
...
REAL, DIMENSION(D%NIJT,NTURB_S),              INTENT(IN)  ::  PTURB_SPP       ! switch for Ocean model version
...
DO JK=IKTB,IKTE
  DO JIJ=IIJB,IIJE
    ...
    ZLWORK2=1.d0 + ZPOTE**PTURB_SPP(JIJ,NBL89EXP)
    PLM(JIJ,JK) = ZLWORK1*(2./ZLWORK2)**PTURB_SPP(JIJ,NUSRBL89)
