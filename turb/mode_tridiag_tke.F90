...
DO JIJ=IIJB,IIJE 
  ...
  PEXPL / PRHODJ(JIJ,IKB) * PA(JIJ,IKB+D%NKL) *  & 
...
DO JIJ=IIJB,IIJE 
  ...
  PEXPL / PRHODJ(JIJ,IKE) * PA(JIJ,IKE) * (PVARM(JIJ,IKE)-PVARM(JIJ,IKE-D%NKL))
ENDDO
!
!
...
!
  ...
  !
  DO JIJ=IIJB,IIJE 
    ZBET(JIJ) = 1. + PIMPL * (PDIAG(JIJ,IKB)-PA(JIJ,IKB+D%NKL) / PRHODJ(JIJ,IKB))
                                                    ! bet = b(ikb)
  ...
  DO JK = IKB+D%NKL,IKE-D%NKL,D%NKL
    DO JIJ=IIJB,IIJE 
      ZGAM(JIJ,JK) = PIMPL * PA(JIJ,JK) / PRHODJ(JIJ,JK-D%NKL) / ZBET(JIJ)  
                                                    ! gam(k) = c(k-1) / bet
  ...
  ! special treatment for the last level
    ZGAM(JIJ,IKE) = PIMPL * PA(JIJ,IKE) / PRHODJ(JIJ,IKE-D%NKL) / ZBET(JIJ) 
                                                    ! gam(k) = c(k-1) / bet
