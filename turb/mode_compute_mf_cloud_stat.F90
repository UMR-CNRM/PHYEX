...
!
    ...
    DO JK=1,IKT 
      DO JIJ=IIJB,IIJE 
        ZFLXZ(JIJ,JK) = -2 * CSTURB%XCTV* PARAMMF%XTAUSIGMF * PEMF(JIJ,JK)* &
...
!
    ...
    DO JK=1,IKT 
      DO JIJ=IIJB,IIJE 
        ZFLXZ2(JIJ,JK) = -2 * CSTURB%XCTV * PARAMMF%XTAUSIGMF * PEMF(JIJ,JK)* &
  ...
  ENDDO
    ...
    DO JK=1,IKT 
      DO JIJ=IIJB,IIJE 
        ZFLXZ3(JIJ,JK) = - CSTURB%XCTV * PARAMMF%XTAUSIGMF * &
