...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
PTP(:,:)= CST%XG*CST%XALPHAOC * ZMZF2D_WORK1(:, :)
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
ZWKLES(:,:) = ZGZ_W_M2D_WORK1(:, :)*ZMZF2D_WORK1(:, :)  
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
ZWKLES(:,:) = -TURBN%XCTP*PSQRT_TKE(:, :)/PLM(:, :)*ZMZF2D_WORK1(:, :)  
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
ZA(:,:)=  -CST%XG * CST%XBETAOC * ZMZF2D_WORK1(:, :)  
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
PWTHV(:,:) = PWTHV(:,:) + ZMZM2D_WORK1(:, :) * ZFLXZ(:,:)  
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
ZSHUGRADWK1_2D(:, :) = PAMOIST(:, :) * 2.* PSRCM(:, :)
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
...
!$mnh_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
ZSHUGRADWK1_2D(:, :) = PATHETA(:, :) * 2.* PSRCM(:, :)
!$mnh_end_expand_array(JIJ=IIJB:IIJE,JK=1:IKT)
