...
def pybinding(fortran_in, scope, fortran_out, python_out, libso,
    ...
    for N in scopeNode.findall('.//{*}dummy-arg-LT/{*}arg-N/{*}N'):
        ...
        if vartype == 'TYPE(DIMPHYEX_T)':
            ...
            moduleList.append('USE MODD_CH_AEROSOL, ONLY: LORILAM, ' +
                              'XINISIGI, XINISIGJ, XINIRADIUSJ, CRGUNIT, XRHOI, &\n' +
                              'NCARB, NSOA, NSP, &\n' +
                              'JP_AER_H2O, JP_AER_DST, JP_AER_BC, JP_AER_OC, JP_AER_SO4')
            ...
            moduleList.append('USE MODD_DUST, ONLY: LDUST, JPDUSTORDER, ' +
                              'XINIRADIUS, CRGUNITD, XINISIG')
            moduleList.append('USE MODD_CSTS_DUST, ONLY: XDENSITY_DUST')
            declList.append('TYPE(PHYEX_AERO_t) :: PHYAERO')
            copyList.append('PHYAERO%LORILAM       = LORILAM')
            copyList.append('PHYAERO%XINISIGI      = XINISIGI')
            copyList.append('PHYAERO%XINISIGJ      = XINISIGJ')
            copyList.append('PHYAERO%XINIRADIUSJ   = XINIRADIUSJ')
            copyList.append('PHYAERO%CRGUNIT       = CRGUNIT')
            copyList.append('PHYAERO%XRHOI         => XRHOI')
            copyList.append('PHYAERO%NCARB         = NCARB')
            copyList.append('PHYAERO%NSOA          = NSOA')
            copyList.append('PHYAERO%NSP           = NSP')
            copyList.append('PHYAERO%JP_AER_OC     = JP_AER_OC')
            copyList.append('PHYAERO%JP_AER_H2O    = JP_AER_H2O')
            copyList.append('PHYAERO%JP_AER_DST    = JP_AER_DST')
            copyList.append('PHYAERO%JP_AER_BC     = JP_AER_BC')
            copyList.append('PHYAERO%JP_AER_OC     = JP_AER_OC')
            copyList.append('PHYAERO%JP_AER_SO4    = JP_AER_SO4')
            ...
            copyList.append('PHYAERO%LDUST         = LDUST')
            copyList.append('PHYAERO%JPDUSTORDER   = JPDUSTORDER')
            copyList.append('PHYAERO%XINIRADIUS    => XINIRADIUS')
            copyList.append('PHYAERO%CRGUNITD      = CRGUNITD')
            copyList.append('PHYAERO%XINISIG       => XINISIG')
            copyList.append('PHYAERO%XDENSITY_DUST = XDENSITY_DUST')
