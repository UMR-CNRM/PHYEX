...
cat > namelist_mods2 <<EOF
 &NAMGFL
   ...
   YEZDIAG_NL(4)%LREQOUT=.FALSE.,
   YEZDIAG_NL(5)%CNAME='EZDIAG05',
   YEZDIAG_NL(5)%LREQOUT=.FALSE.,
   YEZDIAG_NL(6)%CNAME='EZDIAG06',
   YEZDIAG_NL(6)%LREQOUT=.FALSE.,
   YEZDIAG_NL(7)%CNAME='EZDIAG07',
   YEZDIAG_NL(7)%LREQOUT=.FALSE.,
   YEZDIAG_NL(8)%CNAME='EZDIAG08',
   YEZDIAG_NL(8)%LREQOUT=.FALSE.,
   YEZDIAG_NL(9)%CNAME='INPRRTOT3D',
   YEZDIAG_NL(9)%LREQOUT=.TRUE.,
 /
 &NAM_NEBN
   CFRAC_ICE_ADJUST='S',
