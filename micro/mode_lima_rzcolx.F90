...
!
IF (LHOOK) CALL DR_HOOK('LIMA_RZCOLX', 0, ZHOOK_HANDLE)
...
END DO
!
IF (LHOOK) CALL DR_HOOK('LIMA_RZCOLX', 1, ZHOOK_HANDLE)
END SUBROUTINE LIMA_RZCOLX
END MODULE MODE_LIMA_RZCOLX
