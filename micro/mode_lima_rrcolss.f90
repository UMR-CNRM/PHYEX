...
!*       1.0     Initialization
!
IF (LHOOK) CALL DR_HOOK('LIMA_RRCOLSS', 0, ZHOOK_HANDLE)
PRRCOLSS(:,:) = 0.0
...
END DO
!
IF (LHOOK) CALL DR_HOOK('LIMA_RRCOLSS', 1, ZHOOK_HANDLE)
END SUBROUTINE LIMA_RRCOLSS
END MODULE MODE_LIMA_RRCOLSS
