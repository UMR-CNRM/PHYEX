...
!-----------------------------------------------------------------
!     ###########################################################################
SUBROUTINE LIMA_ADJUST_SPLIT(LIMAP, LIMAW, TNSV, D, CST, ICEP, NEBN, TURBN,     &
                             PARAMI, BUCONF, TBUDGETS, KBUDGETS,                &
...
USE MODD_RAIN_ICE_PARAM_N,   ONLY: RAIN_ICE_PARAMN, RAIN_ICE_PARAM_t
