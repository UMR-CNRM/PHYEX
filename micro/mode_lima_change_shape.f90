...
!
! ######################################################################
  SUBROUTINE LIMA_CHANGE_SHAPE(PT, PCTMIN, PDEP, PCI_SHAPE, P_SHCI_HACH)
! ######################################################################
!
!!    PURPOSE
!!    -------
...
!             ------------
!
USE MODD_PARAM_LIMA, ONLY : NNB_CRYSTAL_SHAPE
...
!
REAL, DIMENSION(:),   INTENT(IN)    :: PT  ! Temp at t (K)
REAL, DIMENSION(:),   INTENT(IN)    :: PDEP  ! water vapor deposited on ice crystals
REAL, DIMENSION(:),   INTENT(IN)    :: PCTMIN
REAL, DIMENSION(:,:), INTENT(IN)    :: PCI_SHAPE  ! Nb conc. of ice crystal shapes
REAL, DIMENSION(:,:), INTENT(INOUT) :: P_SHCI_HACH ! for budget
!
!
