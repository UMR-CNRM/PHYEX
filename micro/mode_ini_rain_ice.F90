...
USE MODD_RAIN_ICE_PARAM_n, ONLY: LNEWCOEFF, RAIN_ICE_PARAMN, RAIN_ICE_PARAM_ALLOCATE, X0DEPG, X0DEPH, &
                                 ...
                                 XBETA3, XCOLCS, XCOLEXGH, XCOLEXIG, XCOLEXIH, XCOLEXIS, XCOLEXSG, &
                                 XCOLEXSH, XCOLGH, XCOLIG, XCOLIH, XCOLIR, XCOLIS, XCOLSG, XCOLSH, &
                                 XCRIAUTC, XCRIAUTI, XCRIMSG, XCRIMSS, XDCSLIM, XEX0DEPG, XEX0DEPH, &
                                 XEX0DEPS, XEX0EVAR, XEX1DEPG, XEX1DEPH, XEX1DEPS, XEX1EVAR, XEXCACCR, &
                                 XEXCRIMSG, XEXCRIMSS, XEXCSEDI, XEXFIDRYG, XEXIAGGS, XEXICFRR, &
                                 XEXRCFRI, XEXRSEDI, XEXSEDG, XEXSEDH, XEXSEDR, XEXSEDS, XEXSRIMCG, &
                                 XEXSRIMCG2, XFCACCR, XFCDRYG, XFGWETH, XFIAGGS, XFIDRYG, XFIDRYG2, &
                                 XFRACCSS, XFRDRYG, XFRMIN, XFRWETH, XFSACCRG, XFSCVMG, XFSDRYG, &
                                 XFSEDC, XFSEDG, XFSEDH, XFSEDI, XFSEDR, XFSEDS, XFSWETH, XFWETH, &
                                 XGAMINC_RIM1, XGAMINC_RIM2, XGAMINC_RIM4, XHON, XICFRR, XKER_GWETH, &
                                 XKER_RACCS, XKER_RACCSS, XKER_RDRYG, XKER_RWETH, XKER_SACCRG, &
                                 XKER_SDRYG, XKER_SWETH, XLBGWETH1, XLBGWETH2, XLBGWETH3, XLBRACCS1, &
                                 XLBRACCS2, XLBRACCS3, XLBRDRYG1, XLBRDRYG2, XLBRDRYG3, XLBRWETH1, &
                                 XLBRWETH2, XLBRWETH3, XLBSACCR1, XLBSACCR2, XLBSACCR3, XLBSDRYG1, &
                                 XLBSDRYG2, XLBSDRYG3, XLBSWETH1, XLBSWETH2, XLBSWETH3, XMNU0, XNU10, &
                                 XNU20, XRCFRI, XRDEPGRED, XRDEPSRED, XSCFAC, XSRIMCG, XSRIMCG2, &
                                 XSRIMCG3, XT0CRIAUTI, XTEXAUTI, XTIMAUTC, XTIMAUTI, XRHO00
...
IF (LSNOW_T) THEN
  RAIN_ICE_PARAMN%XGAMINC_BOUND_MIN = (1000.*XTRANS_MP_GAMMAS*XDCSLIM)**XALPHAS
  RAIN_ICE_PARAMN%XGAMINC_BOUND_MAX = (50000.*XTRANS_MP_GAMMAS*XDCSLIM)**XALPHAS
END IF
