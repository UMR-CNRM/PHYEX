...
!-----------------------------------------------------------------
!     ###################
      MODULE MODE_LIMA_RSCOLRG
!     ###################
!
IMPLICIT NONE
CONTAINS
      SUBROUTINE LIMA_RSCOLRG( KSIZE1, KSIZE2, KND, PALPHAS, PZNUS, PALPHAR, PNUR,      &
...
!              ------------
!
USE MODI_GENERAL_GAMMA, ONLY: GENERAL_GAMMA
!
...
!
REAL, DIMENSION(KSIZE1,KSIZE2), INTENT(INOUT) :: PRSCOLRG! Scaled fall speed difference in
...
!*       1.0     Initialization
!
IF (LHOOK) CALL DR_HOOK('LIMA_RSCOLRG', 0, ZHOOK_HANDLE)
PRSCOLRG(:,:) = 0.0
...
END DO
!
IF (LHOOK) CALL DR_HOOK('LIMA_RSCOLRG', 1, ZHOOK_HANDLE)
END SUBROUTINE LIMA_RSCOLRG
END MODULE MODE_LIMA_RSCOLRG
