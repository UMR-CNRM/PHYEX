...
!              ------------
!
USE MODD_CST, ONLY: XALPW, XBETAW, XCL, XCPD, XCPV, XG, XGAMW, XLVTT, XMD, XMV, XPI, XRD, &
                    XRHOLW, XRV, XTT
USE MODD_PARAM_LIMA, ONLY: NMOD_CCN, NMOM_R, XALPHAC, XALPHAR, XBETAHEN_MULTI, XCEXVT, XD, &
                           XFSEDC, XFSEDR, XKHEN_MULTI, XLB, XLBEX, XMUHEN_MULTI, XNUC, XNUR
USE MODD_PARAM_LIMA_WARM, ONLY: NAHEN, NHYP, PARAM_LIMA_WARM_ALLOCATE, PARAM_LIMA_WARM_ASSOCIATE, &
                                X0CNDC, X0EVAR, X1EVAR, X2CNDC, XAC, XACCR1, XACCR2, XACCR3, XACCR4, &
                                XACCR5, XACCR6, XACCR_CLARGE1, XACCR_CLARGE2, XACCR_CSMALL1, &
                                XACCR_CSMALL2, XACCR_RLARGE1, XACCR_RLARGE2, XACCR_RSMALL1, &
                                XACCR_RSMALL2, XAHENG, XAHENG2, XAHENG3, XAHENINTP1, XAHENINTP2, &
                                XAR, XAUTO1, XAUTO2, XBC, XBR, XC1C, XCAUTR, XCC, XCCR, XCEVAP, &
                                XCONCR_PARAM_INI, XCR, XCREC, XCRER, XCSTDCRIT, XCSTHEN, XCXR, XDC, &
                                XDIVA, XDR, XEX0EVAR, XEX1EVAR, XEX2EVAR, XEXCACCR, XF0C, XF0R, &
                                XF1R, XF2C, XFCACCR, XFREFFC, XFREFFR, XFSEDCC, XFSEDCR, XFSEDRC, &
                                XFSEDRR, XGCC, XHYPF12, XHYPF32, XHYPINTP1, XHYPINTP2, XITAUTR, &
                                XITAUTR_THRESHOLD, XKERA1, XKERA2, XLAUTR, XLAUTR_THRESHOLD, XLBC, &
