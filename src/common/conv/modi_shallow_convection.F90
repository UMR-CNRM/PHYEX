...
REAL, DIMENSION(D%NIJT),       INTENT(IN) :: PTKECLS
...
REAL, DIMENSION(D%NIJT,D%NKT), INTENT(INOUT):: PTTEN
REAL, DIMENSION(D%NIJT,D%NKT), INTENT(INOUT):: PRVTEN
REAL, DIMENSION(D%NIJT,D%NKT), INTENT(INOUT):: PRCTEN
REAL, DIMENSION(D%NIJT,D%NKT), INTENT(INOUT):: PRITEN
INTEGER, DIMENSION(D%NIJT),    INTENT(INOUT):: KCLTOP
INTEGER, DIMENSION(D%NIJT),    INTENT(INOUT):: KCLBAS
REAL, DIMENSION(D%NIJT,D%NKT), INTENT(INOUT):: PUMF
LOGICAL,                    INTENT(IN) :: OCH1CONV
INTEGER,                    INTENT(IN) :: KCH1
REAL, DIMENSION(D%NIJT,D%NKT,KCH1), INTENT(IN) :: PCH1
REAL, DIMENSION(D%NIJT,D%NKT,KCH1), INTENT(INOUT):: PCH1TEN
