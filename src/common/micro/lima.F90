...
REAL, DIMENSION(MERGE(D%NIJT,0,OELEC), &
                MERGE(D%NKT,0,OELEC)),OPTIONAL,   INTENT(IN) :: PLATHAM_IAGGS  ! Factor for IAGGS modification due to Efield
...
REAL, DIMENSION(:,:), ALLOCATABLE ::                                       &
     ZTOT_RI_HIND_OTS, ZTOT_RR_HONR_OTS, ZTOT_RC_IMLT_OTS,                 &
     ZTOT_RC_HONC_OTS, ZTOT_RS_DEPS_OTS, ZTOT_RI_AGGS_OTS,                 &
     ZTOT_RI_CNVS_OTS, ZTOT_RG_DEPG_OTS, ZTOT_RC_AUTO_OTS,                 &
     ZTOT_RC_ACCR_OTS, ZTOT_RR_EVAP_OTS,                                   &
     ZTOT_RC_RIMSS_OTS, ZTOT_RC_RIMSG_OTS, ZTOT_RS_RIMCG_OTS,              &
     ZTOT_RR_ACCSS_OTS, ZTOT_RR_ACCSG_OTS, ZTOT_RS_ACCRG_OTS,              &
     ZTOT_RS_CMEL_OTS, ZTOT_RI_CFRZ_OTS, ZTOT_RR_CFRZ_OTS,                 &
     ZTOT_RC_WETG_OTS, ZTOT_RI_WETG_OTS, ZTOT_RR_WETG_OTS,                 &
     ZTOT_RS_WETG_OTS, ZTOT_RC_DRYG_OTS, ZTOT_RI_DRYG_OTS,                 &
     ZTOT_RR_DRYG_OTS, ZTOT_RS_DRYG_OTS, ZTOT_RR_GMLT_OTS,                 &
     ZTOT_RC_BERFI_OTS, ZTOT_RH_WETG_OTS,                                  &
     ZTOT_RV_HENU_OTS, ZTOT_RC_HINC_OTS, ZTOT_RV_HONH_OTS,                 &
     ZTOT_RR_CVRC_OTS, ZTOT_RI_CNVI_OTS, ZTOT_RI_DEPI_OTS,                 &
     ZTOT_RI_HMS_OTS, ZTOT_RI_HMG_OTS, ZTOT_RI_CIBU_OTS,                   &
     ZTOT_RI_RDSF_OTS, ZTOT_RC_CORR2_OTS, ZTOT_RR_CORR2_OTS,               &
     ZTOT_RI_CORR2_OTS
...
ENDIF
IF(OELEC) THEN
  ALLOCATE( ZTOT_RI_HIND_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RR_HONR_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RC_IMLT_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RC_HONC_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RS_DEPS_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_AGGS_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_CNVS_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RG_DEPG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RC_AUTO_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RC_ACCR_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RR_EVAP_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RC_RIMSS_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RC_RIMSG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RS_RIMCG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RR_ACCSS_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RR_ACCSG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RS_ACCRG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RS_CMEL_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_CFRZ_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RR_CFRZ_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RC_WETG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_WETG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RR_WETG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RS_WETG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RC_DRYG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_DRYG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RR_DRYG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RS_DRYG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RR_GMLT_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RC_BERFI_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RH_WETG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RV_HENU_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RC_HINC_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RV_HONH_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RR_CVRC_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_CNVI_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_DEPI_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_HMS_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_HMG_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_CIBU_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_RDSF_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RC_CORR2_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RR_CORR2_OTS (D%NIJT, D%NKT ) )
  ALLOCATE( ZTOT_RI_CORR2_OTS (D%NIJT, D%NKT ) )
END IF
!
...
!
IF ( BUCONF%LBU_ENABLE ) THEN
  IF ( BUCONF%LBUDGET_TH ) ZWKBUD(:,:) = ZTHS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_TH ) &
       CALL TBUDGETS(NBUDGET_TH)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RC .AND. LIMAP%NMOM_C.GE.1 .AND. LIMAP%LSEDC ) ZWKBUD(:,:) = ZRCS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RC .AND. LIMAP%NMOM_C.GE.1 .AND. LIMAP%LSEDC ) &
       CALL TBUDGETS(NBUDGET_RC)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RR .AND. LIMAP%NMOM_R.GE.1 ) ZWKBUD(:,:) = ZRRS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RR .AND. LIMAP%NMOM_R.GE.1 ) &
       CALL TBUDGETS(NBUDGET_RR)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RI .AND. LIMAP%NMOM_I.GE.1 .AND. LIMAP%LSEDI ) ZWKBUD(:,:) = ZRIS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RI .AND. LIMAP%NMOM_I.GE.1 .AND. LIMAP%LSEDI ) &
       CALL TBUDGETS(NBUDGET_RI)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RS .AND. LIMAP%NMOM_S.GE.1 ) ZWKBUD(:,:) = ZRSS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RS .AND. LIMAP%NMOM_S.GE.1 ) &
       CALL TBUDGETS(NBUDGET_RS)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RG .AND. LIMAP%NMOM_G.GE.1 ) ZWKBUD(:,:) = ZRGS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RG .AND. LIMAP%NMOM_G.GE.1 ) &
       CALL TBUDGETS(NBUDGET_RG)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RH .AND. LIMAP%NMOM_H.GE.1 ) ZWKBUD(:,:) = ZRHS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RH .AND. LIMAP%NMOM_H.GE.1 ) &
       CALL TBUDGETS(NBUDGET_RH)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_SV ) THEN
    IF ( LIMAP%LSEDC .AND. LIMAP%NMOM_C.GE.2) ZWKBUD(:,:) = ZCCS(:,:) * PRHODJ(:,:)
    IF ( LIMAP%LSEDC .AND. LIMAP%NMOM_C.GE.2) &
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NC)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
    IF ( LIMAP%NMOM_R.GE.2) ZWKBUD(:,:) = ZCRS(:,:) * PRHODJ(:,:)
    IF ( LIMAP%NMOM_R.GE.2) &
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NR)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
    IF ( LIMAP%LSEDI .AND. LIMAP%NMOM_I.GE.2) THEN
      IF (.NOT. LIMAP%LCRYSTAL_SHAPE) THEN
      ZWKBUD(:,:) = ZCIS(:,:) * PRHODJ(:,:)
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NI)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
      ELSE
        DO ISH = 1, LIMAP%NNB_CRYSTAL_SHAPE
          ZWKBUD(:,:) = ZCIS_SHAPE( :, :, ISH) * PRHODJ( :, :)
          CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NI + ISH - 1)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
        END DO
      END IF
    END IF
    IF ( LIMAP%NMOM_S.GE.2) ZWKBUD(:,:) = ZCSS(:,:) * PRHODJ(:,:)
    IF ( LIMAP%NMOM_S.GE.2) &
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NS)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
    IF ( LIMAP%NMOM_G.GE.2) ZWKBUD(:,:) = ZCGS(:,:) * PRHODJ(:,:)
    IF ( LIMAP%NMOM_G.GE.2) &
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NG)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
    IF ( LIMAP%NMOM_H.GE.2) ZWKBUD(:,:) = ZCHS(:,:) * PRHODJ(:,:)
    IF ( LIMAP%NMOM_H.GE.2) &
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NH)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
    !
    IF (OELEC) THEN
      IF ( LIMAP%LSEDC ) ZWKBUD(:,:) = ZQCS(:,:) * PRHODJ(:,:)
      IF ( LIMAP%LSEDC ) &
        CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 1)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
      ZWKBUD(:,:) = ZQRS(:,:) * PRHODJ(:,:)
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 2)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
      IF ( LIMAP%LSEDI ) ZWKBUD(:,:) = ZQIS(:,:) * PRHODJ(:,:)
      IF ( LIMAP%LSEDI ) &
        CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 3)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
      ZWKBUD(:,:) = ZQSS(:,:) * PRHODJ(:,:)
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 4)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
      ZWKBUD(:,:) = ZQGS(:,:) * PRHODJ(:,:)
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 5)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
      IF (LIMAP%NMOM_H .GE. 1) ZWKBUD(:,:) = ZQHS(:,:) * PRHODJ(:,:)
      IF (LIMAP%NMOM_H .GE. 1) &
        CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 6)%PTR%INIT_PHY(D, 'SEDI', ZWKBUD )
    END IF
  END IF
END IF
!
...
IF ( BUCONF%LBU_ENABLE ) then
  IF ( BUCONF%LBUDGET_TH ) ZWKBUD(:,:) = ZTHS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_TH ) &
       CALL TBUDGETS(NBUDGET_TH)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RC .AND. LIMAP%NMOM_C.GE.1 .AND. LIMAP%LSEDC ) ZWKBUD(:,:) = ZRCS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RC .AND. LIMAP%NMOM_C.GE.1 .AND. LIMAP%LSEDC ) &
       CALL TBUDGETS(NBUDGET_RC)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RR .AND. LIMAP%NMOM_R.GE.1 ) ZWKBUD(:,:) = ZRRS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RR .AND. LIMAP%NMOM_R.GE.1 ) &
       CALL TBUDGETS(NBUDGET_RR)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RI .AND. LIMAP%NMOM_I.GE.1 .AND. LIMAP%LSEDI ) ZWKBUD(:,:) = ZRIS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RI .AND. LIMAP%NMOM_I.GE.1 .AND. LIMAP%LSEDI ) &
       CALL TBUDGETS(NBUDGET_RI)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RS .AND. LIMAP%NMOM_S.GE.1 ) ZWKBUD(:,:) = ZRSS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RS .AND. LIMAP%NMOM_S.GE.1 ) &
       CALL TBUDGETS(NBUDGET_RS)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RG .AND. LIMAP%NMOM_G.GE.1 ) ZWKBUD(:,:) = ZRGS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RG .AND. LIMAP%NMOM_G.GE.1 ) &
       CALL TBUDGETS(NBUDGET_RG)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_RH .AND. LIMAP%NMOM_H.GE.1 ) ZWKBUD(:,:) = ZRHS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RH .AND. LIMAP%NMOM_H.GE.1 ) &
       CALL TBUDGETS(NBUDGET_RH)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
  IF ( BUCONF%LBUDGET_SV ) then
    IF ( LIMAP%LSEDC .AND. LIMAP%NMOM_C.GE.2 ) ZWKBUD(:,:) = ZCCS(:,:) * PRHODJ(:,:)
    IF ( LIMAP%LSEDC .AND. LIMAP%NMOM_C.GE.2 ) &
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NC)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
    IF ( LIMAP%NMOM_R.GE.2 ) ZWKBUD(:,:) = ZCRS(:,:) * PRHODJ(:,:)
    IF ( LIMAP%NMOM_R.GE.2 ) &
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NR)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
    IF ( LIMAP%LSEDI .AND. LIMAP%NMOM_I.GE.2 ) THEN
      IF (.NOT. LIMAP%LCRYSTAL_SHAPE) THEN
      ZWKBUD(:,:) = ZCIS(:,:) * PRHODJ(:,:)
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NI)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
      ELSE
        DO ISH = 1, LIMAP%NNB_CRYSTAL_SHAPE
          ZWKBUD(:,:) = ZCIS_SHAPE( :, :, ISH) * PRHODJ( :, :)
          CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NI + ISH - 1)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
        END DO
      END IF
    END IF
    IF ( LIMAP%NMOM_S.GE.2 ) ZWKBUD(:,:) = ZCSS(:,:) * PRHODJ(:,:)
    IF ( LIMAP%NMOM_S.GE.2 ) &
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NS)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
    IF ( LIMAP%NMOM_G.GE.2 ) ZWKBUD(:,:) = ZCGS(:,:) * PRHODJ(:,:)
    IF ( LIMAP%NMOM_G.GE.2 ) &
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NG)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
    IF ( LIMAP%NMOM_H.GE.2 ) ZWKBUD(:,:) = ZCHS(:,:) * PRHODJ(:,:)
    IF ( LIMAP%NMOM_H.GE.2 ) &
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NH)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
!
    IF (OELEC) then
      IF ( LIMAP%LSEDC ) ZWKBUD(:,:) = ZQCS(:,:) * PRHODJ(:,:)
      IF ( LIMAP%LSEDC ) &
        CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 1)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
      ZWKBUD(:,:) = ZQRS(:,:) * PRHODJ(:,:)
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 2)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
      IF ( LIMAP%LSEDI ) ZWKBUD(:,:) = ZQIS(:,:) * PRHODJ(:,:)
      IF ( LIMAP%LSEDI ) &
        CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 3)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
      ZWKBUD(:,:) = ZQSS(:,:) * PRHODJ(:,:)
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 4)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
      ZWKBUD(:,:) = ZQGS(:,:) * PRHODJ(:,:)
      CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 5)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
      IF (LIMAP%NMOM_H .GE. 1) ZWKBUD(:,:) = ZQHS(:,:) * PRHODJ(:,:)
      IF (LIMAP%NMOM_H .GE. 1) &
        CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_ELECBEG + 6)%PTR%END_PHY(D, 'SEDI', ZWKBUD )
    END IF
  END IF
END IF
!
...
IF (LIMAP%NMOM_C.GE.1 .AND. LIMAP%LDEPOC) THEN
  ...
  IF ( BUCONF%LBUDGET_RC ) CALL TBUDGETS(NBUDGET_RC)%PTR%INIT_PHY(D, 'DEPO', ZWKBUD )
  IF ( BUCONF%LBUDGET_SV .AND. LIMAP%NMOM_C.GE.2) ZWKBUD(:,:) = ZCCS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_SV .AND. LIMAP%NMOM_C.GE.2) &
       CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NC)%PTR%INIT_PHY(D, 'DEPO', ZWKBUD )
  ...
  IF ( BUCONF%LBUDGET_RC ) ZWKBUD(:,:) = ZRCS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_RC ) CALL TBUDGETS(NBUDGET_RC)%PTR%END_PHY(D, 'DEPO', ZWKBUD )
  IF ( BUCONF%LBUDGET_SV .AND. LIMAP%NMOM_C.GE.2) ZWKBUD(:,:) = ZCCS(:,:) * PRHODJ(:,:)
  IF ( BUCONF%LBUDGET_SV .AND. LIMAP%NMOM_C.GE.2) &
       CALL TBUDGETS(NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NC)%PTR%END_PHY(D, 'DEPO', ZWKBUD )
END IF
!
!
!!$Z_RR_CVRC(:,:) = 0.
...
IF ( NEBN%LSUBG_COND ) THEN
   ...
   ELSE
      ...
      ENDDO
   END IF
   ISIZE=D%NIJT*(D%NKTE-D%NKTB+1)
   CALL LIMA_COMPUTE_PDF(CST, LIMAP, ISIZE, LIMAP%CSUBG_AUCV_RC, LIMAP%CSUBG_AUCV_RI, LIMAP%CSUBG_PR_PDF,&
...
! On se cale sur la facon de faire dans ice3 => on fait en sorte que les tendances soient positives
  IF (LIMAP%NMOM_H .GE. 1) THEN
    ZTOT_RI_HIND_OTS(:,:) = ZTOT_RI_HIND(:,:) * ZINV_TSTEP
    ZTOT_RR_HONR_OTS(:,:) = -ZTOT_RR_HONR(:,:) * ZINV_TSTEP
    ZTOT_RC_IMLT_OTS(:,:) = ZTOT_RC_IMLT(:,:) * ZINV_TSTEP
    ZTOT_RC_HONC_OTS(:,:) = -ZTOT_RC_HONC(:,:) * ZINV_TSTEP
    ZTOT_RS_DEPS_OTS(:,:) = ZTOT_RS_DEPS(:,:) * ZINV_TSTEP
    ZTOT_RI_AGGS_OTS(:,:) = -ZTOT_RI_AGGS(:,:) * ZINV_TSTEP
    ZTOT_RI_CNVS_OTS(:,:) = -ZTOT_RI_CNVS(:,:) * ZINV_TSTEP
    ZTOT_RG_DEPG_OTS(:,:) = ZTOT_RG_DEPG(:,:) * ZINV_TSTEP
    ZTOT_RC_AUTO_OTS(:,:) = -ZTOT_RC_AUTO(:,:) * ZINV_TSTEP
    ZTOT_RC_ACCR_OTS(:,:) = -ZTOT_RC_ACCR(:,:) * ZINV_TSTEP
    ZTOT_RR_EVAP_OTS(:,:) = -ZTOT_RR_EVAP(:,:) * ZINV_TSTEP
    ZTOT_RC_RIMSS_OTS(:,:) = ZTOT_RC_RIMSS(:,:) * ZINV_TSTEP
    ZTOT_RC_RIMSG_OTS(:,:) = ZTOT_RC_RIMSG(:,:) * ZINV_TSTEP
    ZTOT_RS_RIMCG_OTS(:,:) = ZTOT_RS_RIMCG(:,:) * ZINV_TSTEP
    ZTOT_RR_ACCSS_OTS(:,:) = ZTOT_RR_ACCSS(:,:) * ZINV_TSTEP
    ZTOT_RR_ACCSG_OTS(:,:) = ZTOT_RR_ACCSG(:,:) * ZINV_TSTEP
    ZTOT_RS_ACCRG_OTS(:,:) = ZTOT_RS_ACCRG(:,:) * ZINV_TSTEP
    ZTOT_RS_CMEL_OTS(:,:) = -ZTOT_RS_CMEL(:,:) * ZINV_TSTEP
    ZTOT_RI_CFRZ_OTS(:,:) = -ZTOT_RI_CFRZ(:,:) * ZINV_TSTEP
    ZTOT_RR_CFRZ_OTS(:,:) = -ZTOT_RR_CFRZ(:,:) * ZINV_TSTEP
    ZTOT_RC_WETG_OTS(:,:) = -ZTOT_RC_WETG(:,:) * ZINV_TSTEP
    ZTOT_RI_WETG_OTS(:,:) = -ZTOT_RI_WETG(:,:) * ZINV_TSTEP
    ZTOT_RR_WETG_OTS(:,:) = -ZTOT_RR_WETG(:,:) * ZINV_TSTEP
    ZTOT_RS_WETG_OTS(:,:) = -ZTOT_RS_WETG(:,:) * ZINV_TSTEP
    ZTOT_RC_DRYG_OTS(:,:) = -ZTOT_RC_DRYG(:,:) * ZINV_TSTEP
    ZTOT_RI_DRYG_OTS(:,:) = -ZTOT_RI_DRYG(:,:) * ZINV_TSTEP
    ZTOT_RR_DRYG_OTS(:,:) = -ZTOT_RR_DRYG(:,:) * ZINV_TSTEP
    ZTOT_RS_DRYG_OTS(:,:) = -ZTOT_RS_DRYG(:,:) * ZINV_TSTEP
    ZTOT_RR_GMLT_OTS(:,:) = ZTOT_RR_GMLT(:,:) * ZINV_TSTEP
    ZTOT_RC_BERFI_OTS(:,:) = -ZTOT_RC_BERFI(:,:) * ZINV_TSTEP
    ZTOT_RH_WETG_OTS(:,:) = ZTOT_RH_WETG(:,:) * ZINV_TSTEP
    ZTOT_RV_HENU_OTS(:,:) = ZTOT_RV_HENU(:,:) * ZINV_TSTEP
    ZTOT_RC_HINC_OTS(:,:) = -ZTOT_RC_HINC(:,:) * ZINV_TSTEP
    ZTOT_RV_HONH_OTS(:,:) = -ZTOT_RV_HONH(:,:) * ZINV_TSTEP
    ZTOT_RR_CVRC_OTS(:,:) = -ZTOT_RR_CVRC(:,:) * ZINV_TSTEP
    ZTOT_RI_CNVI_OTS(:,:) = ZTOT_RI_CNVI(:,:) * ZINV_TSTEP
    ZTOT_RI_DEPI_OTS(:,:) = ZTOT_RI_DEPI(:,:) * ZINV_TSTEP
    ZTOT_RI_HMS_OTS(:,:) = ZTOT_RI_HMS(:,:) * ZINV_TSTEP
    ZTOT_RI_HMG_OTS(:,:) = ZTOT_RI_HMG(:,:) * ZINV_TSTEP
    ZTOT_RI_CIBU_OTS(:,:) = ZTOT_RI_CIBU(:,:) * ZINV_TSTEP
    ZTOT_RI_RDSF_OTS(:,:) = ZTOT_RI_RDSF(:,:) * ZINV_TSTEP
    ZTOT_RC_CORR2_OTS(:,:) = -ZTOT_RC_CORR2(:,:) * ZINV_TSTEP
    ZTOT_RR_CORR2_OTS(:,:) = -ZTOT_RR_CORR2(:,:) * ZINV_TSTEP
    ZTOT_RI_CORR2_OTS(:,:) = -ZTOT_RI_CORR2(:,:) * ZINV_TSTEP
    CALL ELEC_TENDENCIES(D, CST, ICED, ICEP, ELECD, ELECP,                                              &
                         ...
                         ZTOT_RC_WETG_OTS,  ZTOT_RI_WETG_OTS,  ZTOT_RR_WETG_OTS, &
                         ZTOT_RS_WETG_OTS,                                                       &
                         ZTOT_RC_DRYG_OTS,  ZTOT_RI_DRYG_OTS,  ZTOT_RR_DRYG_OTS, &
                         ZTOT_RS_DRYG_OTS,                                                       &
                         ZTOT_RR_GMLT_OTS,  ZTOT_RC_BERFI_OTS,                           &
! variables et processus optionnels propres a la grele : pas encore teste
                         PRWETGH=ZTOT_RH_WETG_OTS,                                               &
...
! variables et processus optionnels propres a lima
                         ...
                         PRVHENC=ZTOT_RV_HENU_OTS,    PRCHINC=ZTOT_RC_HINC_OTS,          &
                         PRVHONH=ZTOT_RV_HONH_OTS,   PRRCVRC=ZTOT_RR_CVRC_OTS,          &
                         PRICNVI=ZTOT_RI_CNVI_OTS,    PRVDEPI=ZTOT_RI_DEPI_OTS,           &
                         PRSHMSI=ZTOT_RI_HMS_OTS,     PRGHMGI=ZTOT_RI_HMG_OTS,            &
                         PRICIBU=ZTOT_RI_CIBU_OTS,    PRIRDSF=ZTOT_RI_RDSF_OTS,           &
                         PRCCORR2=ZTOT_RC_CORR2_OTS, PRRCORR2=ZTOT_RR_CORR2_OTS,        &
                         PRICORR2=ZTOT_RI_CORR2_OTS)
  ELSE
    ZTOT_RI_HIND_OTS(:,:) = ZTOT_RI_HIND(:,:) * ZINV_TSTEP
    ZTOT_RR_HONR_OTS(:,:) = -ZTOT_RR_HONR(:,:) * ZINV_TSTEP
    ZTOT_RC_IMLT_OTS(:,:) = ZTOT_RC_IMLT(:,:) * ZINV_TSTEP
...
! variables et processus optionnels propres a lima
  ...
  !
  DEALLOCATE(ZTOT_RI_HIND_OTS)
  DEALLOCATE(ZTOT_RR_HONR_OTS)
  DEALLOCATE(ZTOT_RC_IMLT_OTS)
  DEALLOCATE(ZTOT_RC_HONC_OTS)
  DEALLOCATE(ZTOT_RS_DEPS_OTS)
  DEALLOCATE(ZTOT_RI_AGGS_OTS)
  DEALLOCATE(ZTOT_RI_CNVS_OTS)
  DEALLOCATE(ZTOT_RG_DEPG_OTS)
  DEALLOCATE(ZTOT_RC_AUTO_OTS)
  DEALLOCATE(ZTOT_RC_ACCR_OTS)
  DEALLOCATE(ZTOT_RR_EVAP_OTS)
  DEALLOCATE(ZTOT_RC_RIMSS_OTS)
  DEALLOCATE(ZTOT_RC_RIMSG_OTS)
  DEALLOCATE(ZTOT_RS_RIMCG_OTS)
  DEALLOCATE(ZTOT_RR_ACCSS_OTS)
  DEALLOCATE(ZTOT_RR_ACCSG_OTS)
  DEALLOCATE(ZTOT_RS_ACCRG_OTS)
  DEALLOCATE(ZTOT_RS_CMEL_OTS)
  DEALLOCATE(ZTOT_RI_CFRZ_OTS)
  DEALLOCATE(ZTOT_RR_CFRZ_OTS)
  DEALLOCATE(ZTOT_RC_WETG_OTS)
  DEALLOCATE(ZTOT_RI_WETG_OTS)
  DEALLOCATE(ZTOT_RR_WETG_OTS)
  DEALLOCATE(ZTOT_RS_WETG_OTS)
  DEALLOCATE(ZTOT_RC_DRYG_OTS)
  DEALLOCATE(ZTOT_RI_DRYG_OTS)
  DEALLOCATE(ZTOT_RR_DRYG_OTS)
  DEALLOCATE(ZTOT_RS_DRYG_OTS)
  DEALLOCATE(ZTOT_RR_GMLT_OTS)
  DEALLOCATE(ZTOT_RC_BERFI_OTS)
  DEALLOCATE(ZTOT_RH_WETG_OTS)
  DEALLOCATE(ZTOT_RV_HENU_OTS)
  DEALLOCATE(ZTOT_RC_HINC_OTS)
  DEALLOCATE(ZTOT_RV_HONH_OTS)
  DEALLOCATE(ZTOT_RR_CVRC_OTS)
  DEALLOCATE(ZTOT_RI_CNVI_OTS)
  DEALLOCATE(ZTOT_RI_DEPI_OTS)
  DEALLOCATE(ZTOT_RI_HMS_OTS)
  DEALLOCATE(ZTOT_RI_HMG_OTS)
  DEALLOCATE(ZTOT_RI_CIBU_OTS)
  DEALLOCATE(ZTOT_RI_RDSF_OTS)
  DEALLOCATE(ZTOT_RC_CORR2_OTS)
  DEALLOCATE(ZTOT_RR_CORR2_OTS)
  DEALLOCATE(ZTOT_RI_CORR2_OTS)
  !
END IF
!
...
IF ( BUCONF%LBU_ENABLE ) then
  ...
  IF ( BUCONF%LBUDGET_TH ) then
    ZWKBUD(:,:) = ZTOT_TH_EVAP (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'REVA', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_HONC (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'HONC', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_HONR (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'HONR', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_DEPS (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'DEPS', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_DEPI (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'DEPI', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_DEPG (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'DEPG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_IMLT (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'IMLT', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_BERFI(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'BERFI', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_RIM  (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'RIM', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_ACC  (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'ACC', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_CFRZ (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'CFRZ', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_WETG (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_DRYG (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'DRYG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_GMLT (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'GMLT', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_DEPH (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'DEPH', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_WETH (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_TH_HMLT (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_TH)%PTR%ADD_PHY(D, 'HMLT', ZWKBUD )
  END IF

  IF ( BUCONF%LBUDGET_RV ) then
    ZWKBUD(:,:) = -ZTOT_RR_EVAP (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RV)%PTR%ADD_PHY(D, 'REVA', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RS_DEPS (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RV)%PTR%ADD_PHY(D, 'DEPS', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RI_DEPI (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RV)%PTR%ADD_PHY(D, 'DEPI', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RG_DEPG (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RV)%PTR%ADD_PHY(D, 'DEPG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RV_CORR2(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RV)%PTR%ADD_PHY(D, 'CORR2', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RH_DEPH (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RV)%PTR%ADD_PHY(D, 'DEPH', ZWKBUD )
  END IF

  IF ( BUCONF%LBUDGET_RC ) then
    ZWKBUD(:,:) = ZTOT_RC_AUTO (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RC)%PTR%ADD_PHY(D, 'AUTO', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RC_ACCR (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RC)%PTR%ADD_PHY(D, 'ACCR', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RC_HONC (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RC)%PTR%ADD_PHY(D, 'HONC', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RC_IMLT (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RC)%PTR%ADD_PHY(D, 'IMLT', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RC_BERFI(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RC)%PTR%ADD_PHY(D, 'BERFI', ZWKBUD )
    ZWKBUD(:,:) = (ZTOT_RC_RIMSS(:,:) + ZTOT_RC_RIMSG(:,:)) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RC)%PTR%ADD_PHY(D, 'RIM', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RC_WETG (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RC)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RC_DRYG (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RC)%PTR%ADD_PHY(D, 'DRYG', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RR_CVRC (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RC)%PTR%ADD_PHY(D, 'CVRC', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RC_CORR2(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RC)%PTR%ADD_PHY(D, 'CORR2', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RC_WETH(:,:)  * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RC)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
  END IF

  IF ( BUCONF%LBUDGET_RR ) then
    ZWKBUD(:,:) = -ZTOT_RC_AUTO(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'AUTO', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RC_ACCR(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'ACCR', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RR_EVAP(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'REVA', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RR_HONR(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'HONR', ZWKBUD )
    ZWKBUD(:,:) = (-ZTOT_RR_ACCSS(:,:) - ZTOT_RR_ACCSG(:,:)) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'ACC', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RR_CFRZ(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'CFRZ', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RR_WETG(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RR_DRYG(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'DRYG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RR_GMLT(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'GMLT', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RR_CVRC(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'CVRC', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RR_CORR2(:,:)* ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'CORR2', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RR_WETH(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RR_HMLT(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RR)%PTR%ADD_PHY(D, 'HMLT', ZWKBUD )
  END IF

  IF ( BUCONF%LBUDGET_RI ) then
    ZWKBUD(:,:) = -ZTOT_RC_HONC (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'HONC', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_CNVI (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'CNVI', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_CNVS (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'CNVS', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_AGGS (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'AGGS', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RC_IMLT (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'IMLT', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RC_BERFI(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'BERFI', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_HMS  (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'HMS', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_CFRZ (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'CFRZ', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_DEPI (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'DEPI', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_CIBU (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'CIBU', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_RDSF (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'RDSF', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_WETG (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_DRYG (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'DRYG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_HMG  (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'HMG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_CORR2(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'CORR2', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RI_WETH (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
    IF (LIMAP%LCRYSTAL_SHAPE) THEN
      ZWKBUD(:,:) = ZTOT_SHRI_ISCS (:,:) * ZRHODJONTSTEP(:,:)
      CALL TBUDGETS(NBUDGET_RI)%PTR%ADD_PHY(D, 'ISCS', ZWKBUD )
    END IF
  END IF

  IF ( BUCONF%LBUDGET_RS ) then
    ZWKBUD(:,:) = -ZTOT_RI_CNVI(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'CNVI', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RS_DEPS(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'DEPS', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RI_CNVS(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'CNVS', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RI_AGGS(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'AGGS', ZWKBUD )
!    ZWKBUD(:,:) = ztot_rs_rim (:,:) * zrhodjontstep(:,:)
!    call TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'RIM', ZWKBUD )
    ZWKBUD(:,:) = (-ZTOT_RC_RIMSS(:,:) -  ZTOT_RS_RIMCG(:,:)) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'RIM', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RS_HMS (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'HMS', ZWKBUD )
!    ZWKBUD(:,:) = ztot_rs_acc (:,:) * zrhodjontstep(:,:)
!    call TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'ACC', ZWKBUD )
    ZWKBUD(:,:) = (ZTOT_RR_ACCSS(:,:) - ZTOT_RS_ACCRG (:,:)) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'ACC', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RS_CMEL(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'CMEL', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RI_CIBU(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'CIBU', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RS_WETG(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RS_DRYG(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'DRYG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RS_WETH(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
    IF (LIMAP%LCRYSTAL_SHAPE) THEN
      ZWKBUD(:,:) = -ZTOT_SHRI_ISCS (:,:) * ZRHODJONTSTEP(:,:)
      CALL TBUDGETS(NBUDGET_RS)%PTR%ADD_PHY(D, 'ISCS', ZWKBUD )
    END IF
  END IF

  IF ( BUCONF%LBUDGET_RG ) then
    ZWKBUD(:,:) = -ZTOT_RR_HONR(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'HONR', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RG_DEPG(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'DEPG', ZWKBUD )
    ZWKBUD(:,:) = (-ZTOT_RC_RIMSG(:,:) +  ZTOT_RS_RIMCG(:,:) ) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'RIM', ZWKBUD )
    ZWKBUD(:,:) = (ZTOT_RR_ACCSG(:,:) + ZTOT_RS_ACCRG (:,:)) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'ACC', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RS_CMEL(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'CMEL', ZWKBUD )
    ZWKBUD(:,:) = ( -ZTOT_RR_CFRZ(:,:) - ZTOT_RI_CFRZ(:,:) ) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'CFRZ', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RI_RDSF(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'RDSF', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RG_WETG(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RG_DRYG(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'DRYG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RG_HMG (:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'HMG', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RR_GMLT(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'GMLT', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RG_WETH(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RG_COHG(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RG)%PTR%ADD_PHY(D, 'COHG', ZWKBUD )
  END IF

  IF ( BUCONF%LBUDGET_RH ) then
    ZWKBUD(:,:) = ZTOT_RH_WETG(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RH)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RH_DEPH(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RH)%PTR%ADD_PHY(D, 'DEPH', ZWKBUD )
    ZWKBUD(:,:) = ZTOT_RH_WETH(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RH)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RG_COHG(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RH)%PTR%ADD_PHY(D, 'COHG', ZWKBUD )
    ZWKBUD(:,:) = -ZTOT_RR_HMLT(:,:) * ZRHODJONTSTEP(:,:)
    CALL TBUDGETS(NBUDGET_RH)%PTR%ADD_PHY(D, 'HMLT', ZWKBUD )
  END IF
  ...
  IF ( BUCONF%LBUDGET_SV ) then
    ...
    IF (LIMAP%NMOM_C.GE.2) then
       ...
       ZWKBUD(:,:) = ZTOT_CC_SELF (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'SELF', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CC_AUTO (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'AUTO', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CC_ACCR (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'ACCR', ZWKBUD )
       !ZWKBUD(:,:) = 0.
       !call TBUDGETS(IDX)%PTR%ADD_PHY(D, 'REVA', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CC_HONC (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'HONC', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CC_IMLT (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'IMLT', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CC_RIM  (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'RIM', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CC_WETG (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CC_DRYG (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'DRYG', ZWKBUD )
       ZWKBUD(:,:) = -ZTOT_CR_CVRC (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CVRC', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CC_CORR2(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CORR2', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CC_WETH (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
    END IF
    !
    ! Rain drops
    !
    IF (LIMAP%NMOM_R.GE.2) then
       ...
       ZWKBUD(:,:) = ZTOT_CR_AUTO(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'AUTO', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_SCBU(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'SCBU', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_EVAP(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'REVA', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_BRKU(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'BRKU', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_HONR(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'HONR', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_ACC (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'ACC', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_CFRZ(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CFRZ', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_WETG(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_DRYG(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'DRYG', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_GMLT(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'GMLT', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_CVRC(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CVRC', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_CORR2(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CORR2', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_WETH(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CR_HMLT(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'HMLT', ZWKBUD )
    END IF
    !
    ! Ice crystals
    !
    IF (LIMAP%NMOM_I.GE.2) then
      IF (.NOT. LIMAP%LCRYSTAL_SHAPE) THEN
       ...
       ZWKBUD(:,:) = -ZTOT_CC_HONC (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'HONC', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_CNVI (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CNVI', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_CNVS (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CNVS', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_AGGS (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'AGGS', ZWKBUD )
       ZWKBUD(:,:) = -ZTOT_CC_IMLT (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'IMLT', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_HMS  (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'HMS', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_CFRZ (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CFRZ', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_CIBU (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CIBU', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_RDSF (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'RDSF', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_WETG (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_DRYG (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'DRYG', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_HMG  (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'HMG', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_CORR2(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CORR2', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CI_WETH (:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
      ELSE
         DO ISH = 1, LIMAP%NNB_CRYSTAL_SHAPE
           IDX = NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_NI + ISH - 1
           ZWKBUD(:,:) = ztot_shci_honc (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'HONC', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_cnvi (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CNVI', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_hach (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'HACH', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_cnvs (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CNVS', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_aggs (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'AGGS', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_imlt (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'IMLT', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_hms  (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'HMS', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_cfrz (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CFRZ', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_cibu (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CIBU', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_rdsf (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'RDSF', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_wetg (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_dryg (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'DRYG', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_hmg  (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'HMG', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_corr2(:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CORR2', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_isc  (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'ISC', ZWKBUD )
           ZWKBUD(:,:) = ztot_shci_iscs (:,:,ISH) * ZRHODJONTSTEP(:,:)
           CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'ISCS', ZWKBUD )
          END DO
      END IF
    END IF
    !
    ...
    IF (LIMAP%NMOM_S.GE.2) then
       ...
       ZWKBUD(:,:) = -ZTOT_CI_CNVS(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CNVS', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CS_RIM(:,:)  * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'RIM', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CS_ACC(:,:)  * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'ACC', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CS_CMEL(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CMEL', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CS_SSC(:,:)  * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'SSC', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CS_WETG(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CS_DRYG(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'DRYG', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CS_WETH(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
       IF (LIMAP%LCRYSTAL_SHAPE) THEN
         ...
         END DO
         ZWKBUD(:,:) = -ZAUX_ISCS(:,:) * ZRHODJONTSTEP(:,:)
         CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'ISCS', ZWKBUD )
    ...
    IF (LIMAP%NMOM_G.GE.2) then
       ...
       ZWKBUD(:,:) = -ZTOT_CR_CFRZ(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'CFRZ', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CG_WETG(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'WETG', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CG_GMLT(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'GMLT', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CG_WETH(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'WETH', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CG_COHG(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'COHG', ZWKBUD )
    END IF
    !
    ! Hail
    !
    IF (LIMAP%NMOM_H.GE.2) then
       ...
       ZWKBUD(:,:) = -ZTOT_CG_COHG(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'COHG', ZWKBUD )
       ZWKBUD(:,:) = ZTOT_CH_HMLT(:,:) * ZRHODJONTSTEP(:,:)
       CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'HMLT', ZWKBUD )
    END IF

    DO II = 1, LIMAP%NMOD_IFN
      IDX = NBUDGET_SV1 - 1 + TNSV%NSV_LIMA_IFN_NUCL + II - 1
      ZWKBUD(:,:) = ZTOT_IFNN_IMLT(:, :, II) * ZRHODJONTSTEP(:,:)
      CALL TBUDGETS(IDX)%PTR%ADD_PHY(D, 'IMLT', ZWKBUD )
    END DO
  END IF
