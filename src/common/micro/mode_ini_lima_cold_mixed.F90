...
USE MODD_PARAM_LIMA, ONLY: CPRISTINE_ICE_LIMA, HTYPE_CRYSTAL_SHAPE, LCRIAUTI, LCRYSTAL_SHAPE, &
                           ...
                           XALPHAI, XALPHAR, XALPHAS, XAREA1, XBCRIAUTI, XCEXVT, XCRIAUTI, XD, &
                           XDSI0, XDT0, XFACTNUC_CON, XFACTNUC_DEP, XFSEDC, XFSEDR, XGAMMA, XH, &
                           XLB, XLBEX, XMVDMIN_G, XNUC, XNUG, XNUI, XNUR, XNUS, XRHO_CFDC, XSW0, &
                           XT0, XT0CRIAUTI, XTX1, XTX2, XWEIGHT
USE MODD_PARAM_LIMA_WARM, ONLY: XAR, XBR, XCR, XDR, XNR
USE MODD_PARAM_LIMA_COLD, ONLY: NSCLBDAI, NSCLBDAS, PARAM_LIMA_COLD, PARAM_LIMA_COLD_ALLOCATE, &
                                PARAM_LIMA_COLD_ALLOCATE_1D, PARAM_LIMA_COLD_ALLOCATE_3D, &
                                PARAM_LIMA_COLD_ALLOCATE_4D, PARAM_LIMA_COLD_ASSOCIATE, X0DEPI, &
                                X0DEPI_SHAPE, X0DEPS, X1DEPS, X2DEPI, X2DEPI_SHAPE, XACCS1, &
                                XAGGS_CLARGE1, XAGGS_CLARGE2, XAGGS_RLARGE1, XAGGS_RLARGE1_SHAPE, &
                                XAGGS_RLARGE2, XAGGS_RLARGE2_SHAPE, XAI, XAI_SHAPE, XALPHA1, &
                                XALPHA2, XAS, XAUTO3, XAUTO4, XBETA1, XBETA2, XBI, XBI_SHAPE, &
                                XBS, XC0DEPIS, XC0DEPIS_SHAPE, XC0DEPSI, XC1DEPIS, XC1DEPIS_SHAPE, &
                                XC1DEPSI, XC1I, XC1I_SHAPE, XC1S, XC1_HONH, XC2_HONH, XC3_HONH, &
                                XCCS, XCEXP_DIFVAP_HONH, XCOEF_DIFVAP_HONH, XCOLEXII, XCOLEXIS, &
                                XCOLEXSS, XCOLII, XCOLIS, XCOLSS, XCRITSAT1_HONH, XCRITSAT2_HONH, &
                                XCS, XCXS, XC_HONC, XC_I, XC_I_SHAPE, XDELTAI, XDELTAI_SHAPE, XDI, &
                                XDICNVS_LIM, XDI_SHAPE, XDLNJODT1_HONH, XDLNJODT2_HONH, XDS, &
                                XDSCNVI_LIM, XEX0DEPS, XEX1DEPS, XEXIAGGS, XEXSEDS, XEXSI_DEP, &
                                XEXTT_CON, XEX_CON, XEX_DEP, XF0I, XF0IS, XF0S, XF1IS, XF1S, &
                                XF2I, XFIAGGS, XFISCS, XFNISCI, XFNSSCS, XFREFFI, XFREFFI_SHAPE, &
                                XFSEDCI, XFSEDCI_SHAPE, XFSEDCS, XFSEDRI, XFSEDRI_SHAPE, &
                                XFSEDRI_TOT_SHAPE, XFSEDRS, XFSEDS, XFVELOS, XGAMMAI, XGAMMAI_SHAPE, &
                                XITAUTS, XITAUTS_THRESHOLD, XKER_N_ISCI, XKER_N_ISCI_SHAPE, &
                                XKER_N_SSCS, XKER_R_ISCI_SHAPE, XKER_ZRNIC_A1, XKER_ZRNIC_A2, &
                                XLAUTS, XLAUTS_THRESHOLD, XLBDAICNVS_LIM, XLBDASCNVI_LIM, &
                                XLBDASCNVI_MAX, XLBDAS_MAX, XLBDAS_MIN, XLBEXI, XLBEXI_SHAPE, &
                                XLBEXS, XLBI, XLBISCS1, XLBISCS2, XLBISCS3, XLBI_SHAPE, XLBNISCI1, &
                                XLBNISCI2, XLBNSSCS1, XLBNSSCS2, XLBS, XMNU0, XNS, XNU10, XNU20, &
                                XNUC_CON, XNUC_DEP, XR0DEPIS, XR0DEPIS_SHAPE, XR0DEPSI, XR1DEPIS, &
                                XR1DEPIS_SHAPE, XR1DEPSI, XRCOEF_HONH, XREFFI, XRHOI_HONH, XR_HONC, &
                                XSCFAC, XSCINTP1I, XSCINTP1S, XSCINTP2I, XSCINTP2S, XSCLBDAI_MAX, &
                                XSCLBDAI_MIN, XSELFI, XSPONBUDS1, XSPONBUDS2, XSPONBUDS3, XSPONCOEFS2, &
                                XTEXAUTI, XTEXP1_HONC, XTEXP2_HONC, XTEXP3_HONC, XTEXP4_HONC, &
                                XTEXP5_HONC, XTIMAUTI, XTMAX_HONH, XTMIN_HONH, XTRANS_MP_GAMMAS
USE MODD_PARAM_LIMA_MIXED, ONLY: NACCLBDAR, NACCLBDAS, NDRYLBDAG, NDRYLBDAR, NDRYLBDAS, NGAMINC, &
                                 NWETLBDAG, NWETLBDAH, NWETLBDAR, NWETLBDAS, PARAM_LIMA_MIXED, &
                                 PARAM_LIMA_MIXED_ALLOCATE, PARAM_LIMA_MIXED_ASSOCIATE, X0DEPG, &
                                 X0DEPH, X1DEPG, X1DEPH, XACCINTP1R, XACCINTP2R, XACCLBDAR_MAX, &
                                 XACCLBDAR_MIN, XACCLBDAS_MAX, XACCLBDAS_MIN, XAG, XAH, XALPHAH, &
                                 XBG, XBH, XC1G, XC1H, XCCG, XCCH, XCG, XCH, XCIBUINTP1_G, &
                                 XCIBUINTP1_S, XCIBUINTP2_S, XCIBUINTP_G, XCIBUINTP_S, XCOLCG, &
                                 XCOLCS, XCOLEXIG, XCOLEXSG, XCOLIG, XCOLIR, XCOLSG, XCRIMSG, &
                                 XCRIMSS, XCXG, XCXH, XDCGLIM_CIBU_MIN, XDCRLIM_RDSF_MIN, XDCSLIM, &
                                 XDCSLIM_CIBU_MAX, XDCSLIM_CIBU_MIN, XDG, XDH, XDRYINTP1G, &
                                 XDRYINTP1R, XDRYINTP1S, XDRYINTP2G, XDRYINTP2R, XDRYINTP2S, &
                                 XDRYLBDAG_MAX, XDRYLBDAG_MIN, XDRYLBDAR_MAX, XDRYLBDAR_MIN, &
                                 XDRYLBDAS_MAX, XDRYLBDAS_MIN, XEX0DEPG, XEX0DEPH, XEX1DEPG, &
                                 XEX1DEPH, XEXCRIMSG, XEXCRIMSS, XEXICFRR, XEXRCFRI, XEXSEDG, &
                                 XEXSEDH, XEXSRIMCG, XEXSRIMCG2, XF0G, XF0H, XF1G, XF1H, &
                                 XFACTOR_CIBU_NI, XFACTOR_CIBU_RI, XFACTOR_RDSF_NI, XFCDRYG, &
                                 XFGWETH, XFIDRYG, XFNGWETH, XFNRACCSS, XFNRDRYG, XFNSACCRG, &
                                 XFNSDRYG, XFNSWETH, XFRACCSS, XFRDRYG, XFSACCRG, XFSCVMG, &
                                 XFSDRYG, XFSEDCG, XFSEDCH, XFSEDG, XFSEDH, XFSEDRG, XFSEDRH, &
                                 XFSWETH, XFWETH, XGAMINC_BOUND_CIBU_GMIN, XGAMINC_BOUND_CIBU_SMIN, &
                                 XGAMINC_BOUND_MIN, XGAMINC_BOUND_RDSF_RMIN, XGAMINC_CIBU_G, &
                                 XGAMINC_CIBU_S, XGAMINC_HMC, XGAMINC_HMC_BOUND_MIN, XGAMINC_RDSF_R, &
                                 XGAMINC_RIM1, XGAMINC_RIM2, XGAMINC_RIM4, XHM1, XHM2, XHMLINTP1, &
                                 XHMLINTP2, XHMSINTP1, XHMSINTP2, XHMTMAX, XHMTMIN, XHM_COLLCG, &
                                 XHM_COLLCS, XHM_FACTG, XHM_FACTS, XHM_YIELD, XICFRR, XKER_GWETH, &
                                 XKER_N_GWETH, XKER_N_RACCS, XKER_N_RACCSS, XKER_N_RDRYG, &
                                 XKER_N_SACCRG, XKER_N_SDRYG, XKER_N_SWETH, XKER_RACCS, &
                                 XKER_RACCSS, XKER_RDRYG, XKER_SACCRG, XKER_SDRYG, XKER_SWETH, &
                                 XLBDAG_MAX, XLBEXG, XLBEXH, XLBG, XLBGWETH1, XLBGWETH2, XLBGWETH3, &
                                 XLBH, XLBNGWETH1, XLBNGWETH2, XLBNGWETH3, XLBNRACCS1, XLBNRACCS2, &
                                 XLBNRACCS3, XLBNRDRYG1, XLBNRDRYG2, XLBNRDRYG3, XLBNSACCR1, &
                                 XLBNSACCR2, XLBNSACCR3, XLBNSDRYG1, XLBNSDRYG2, XLBNSDRYG3, &
                                 XLBNSWETH1, XLBNSWETH2, XLBNSWETH3, XLBRACCS1, XLBRACCS2, &
                                 XLBRACCS3, XLBRDRYG1, XLBRDRYG2, XLBRDRYG3, XLBSACCR1, XLBSACCR2, &
                                 XLBSACCR3, XLBSDRYG1, XLBSDRYG2, XLBSDRYG3, XLBSWETH1, XLBSWETH2, &
                                 XLBSWETH3, XMAXLBDG, XMINDG, XMOMGG_CIBU_1, XMOMGG_CIBU_2, &
                                 XMOMGR_RDSF, XMOMGS_CIBU_1, XMOMGS_CIBU_2, XMOMGS_CIBU_3, XNG, &
                                 XNUH, XRCFRI, XRDSFINTP1_R, XRDSFINTP_R, XRIMINTP1, XRIMINTP2, &
                                 XSCLBDAS_MAX, XSCLBDAS_MIN, XSIG_PSH, XSRIMCG, XSRIMCG2, XSRIMCG3, &
                                 XTM_PSH, XWETINTP1G, XWETINTP1H, XWETINTP1S, XWETINTP2G, XWETINTP2H, &
                                 XWETINTP2S, XWETLBDAG_MAX, XWETLBDAG_MIN, XWETLBDAH_MAX, XWETLBDAH_MIN, &
                                 XWETLBDAS_MAX, XWETLBDAS_MIN, XFNRWETH, XKER_N_RWETH, XWETLBDAR_MIN, &
                                 XLBNRWETH1, XLBNRWETH2, XLBNRWETH3, XWETINTP1R, XWETINTP2R,XFRWETH, &
                                 XLBRWETH1, XLBRWETH2, XLBRWETH3, XWETLBDAR_MAX,XKER_RWETH
!
USE MODE_MSG, ONLY: PRINT_MSG
USE MODD_PRECISION, ONLY: MNHREAL64
!
USE MODE_LIMA_FUNCTIONS, ONLY: MOMG, GAUHER
USE MODI_GAMMA, ONLY: GAMMA, GAMMA_X0D
USE MODI_GAMMA_INC, ONLY: GAMMA_INC
