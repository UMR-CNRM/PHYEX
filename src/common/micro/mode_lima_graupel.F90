...
CONTAINS
!     #################################################################################
  SUBROUTINE LIMA_GRAUPEL (PTSTEP, ODCOMPUTE,                                     &
...
REAL, DIMENSION(:),   INTENT(OUT)   :: P_RH_WETG
!
...
!
CONTAINS
  FUNCTION GET_XKER_SDRYG(KG,KS) RESULT(RET)
    INTEGER, DIMENSION(:), INTENT(IN) :: KG
    INTEGER, DIMENSION(:), INTENT(IN) :: KS
    REAL, DIMENSION(SIZE(KS)) :: RET
    !
    INTEGER I
    !
    DO I=1,SIZE(KG)
...
!-------------------------------------------------------------------------------
!
  FUNCTION GET_XKER_N_SDRYG(KG,KS) RESULT(RET)
    INTEGER, DIMENSION(:), INTENT(IN) :: KG
    INTEGER, DIMENSION(:), INTENT(IN) :: KS
    REAL, DIMENSION(SIZE(KS)) :: RET
    !
...
!-------------------------------------------------------------------------------
!
  FUNCTION GET_XKER_RDRYG(KG,KR) RESULT(RET)
    INTEGER, DIMENSION(:), INTENT(IN) :: KG
    INTEGER, DIMENSION(:), INTENT(IN) :: KR
    REAL, DIMENSION(SIZE(KR)) :: RET
    !
    INTEGER I
    !
    DO I=1,SIZE(KG)
...
!-------------------------------------------------------------------------------
!
  FUNCTION GET_XKER_N_RDRYG(KG,KR) RESULT(RET)
    INTEGER, DIMENSION(:), INTENT(IN) :: KG
    INTEGER, DIMENSION(:), INTENT(IN) :: KR
    REAL, DIMENSION(SIZE(KR)) :: RET
    !
