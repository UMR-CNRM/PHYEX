...
REAL,    DIMENSION(SIZE(PRI,1),SIZE(PRI,2),SIZE(PRI,3),LIMAP%NNB_CRYSTAL_SHAPE) :: ZCSHAPE  ! nb conc. ratio for each habit
REAL,    DIMENSION(SIZE(PRI,1),SIZE(PRI,2),SIZE(PRI,3),LIMAP%NNB_CRYSTAL_SHAPE) :: ZRSHAPE  ! mass ratio for each habit
REAL(KIND=JPHOOK) :: ZHOOK_HANDLE
!
!-----------------------------------------------------------------------------
!
