...
!
CONTAINS
  FUNCTION GET_XKER_SWETH(KH,KS) RESULT(RET)
    INTEGER, DIMENSION(:), INTENT(IN) :: KH
...
!-------------------------------------------------------------------------------
!
  FUNCTION GET_XKER_N_SWETH(KH,KS) RESULT(RET)
    INTEGER, DIMENSION(:), INTENT(IN) :: KH
    INTEGER, DIMENSION(:), INTENT(IN) :: KS
    REAL, DIMENSION(SIZE(KS)) :: RET
    !
...
!-------------------------------------------------------------------------------
!
  FUNCTION GET_XKER_GWETH(KH,KG) RESULT(RET)
    INTEGER, DIMENSION(:), INTENT(IN) :: KH
    INTEGER, DIMENSION(:), INTENT(IN) :: KG
    REAL, DIMENSION(SIZE(KG)) :: RET
    !
    INTEGER I
    !
    DO I=1,SIZE(KH)
...
!-------------------------------------------------------------------------------
!
  FUNCTION GET_XKER_N_GWETH(KH,KG) RESULT(RET)
    INTEGER, DIMENSION(:), INTENT(IN) :: KH
    INTEGER, DIMENSION(:), INTENT(IN) :: KG
    REAL, DIMENSION(SIZE(KG)) :: RET
    !
