...
USE MODI_RAIN_ICE_OLD, ONLY: RAIN_ICE_OLD
...
CALL INIT_PHYEX(KRR, PHYEX, MISC, OWARM, OSEDIC, OCND2, C_SEDIM, CSUBG_AUCV_RC, PTSTEP)
TLES%LLES=.FALSE.
  ...
  DO JLON = 1, NPROMA
    ...
    INUMPIN = 0
      ...
      CALL RAIN_ICE_OLD(D=D, CST=PHYEX%CST, PARAMI=PHYEX%PARAM_ICEN,                                   &
                        ICEP=PHYEX%RAIN_ICE_PARAMN, ICED=PHYEX%RAIN_ICE_DESCRN, BUCONF=MISC%TBUCONF, TLES=TLES,       &
...
SUBROUTINE INIT_PHYEX(KRR, PHYEX, MISC, LDWARM, LDSEDIC, LDCND2, C_SEDIM, CSUBG_AUCV_RC, PTSTEP)
