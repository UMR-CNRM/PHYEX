...
USE MODI_LIMA_ADJUST_SPLIT, ONLY: LIMA_ADJUST_SPLIT
...
TYPE(MISC_OFFLINE_t), TARGET :: MISC
LOGICAL                  :: LLCHECK
LOGICAL                  :: LLCHECKDIFF
LOGICAL                  :: LLDIFF
...
MISC%TPFILE%NLU=0
PHYAERO%LSALT         = MISC%LSALT
PHYAERO%NMODE_SLT     = MISC%NMODE_SLT
PHYAERO%XINISIG_SLT   => MISC%XINISIG_SLT
PHYAERO%CRGUNITS      = MISC%CRGUNITS
PHYAERO%XINIRADIUS_SLT=> MISC%XINIRADIUS_SLT
PHYAERO%XDENSITY_SALT = MISC%XDENSITY_SALT
