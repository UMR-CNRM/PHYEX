...
REAL,    ALLOCATABLE, DIMENSION(:,:,:)   :: ZDUM1
REAL,    ALLOCATABLE, DIMENSION(:,:,:)   :: ZDUM2
REAL,    ALLOCATABLE, DIMENSION(:,:,:)   :: ZDUM3
REAL,    ALLOCATABLE, DIMENSION(:,:,:)   :: ZDUM4
...
&PINPRS, PINPRS_OUT, PINPRG, PINPRG_OUT, ZINDEP, ZINDEP_OUT, ZRAINFR, ZRAINFR_OUT, PFPR, PFPR_OUT, &
&ZDUM1, ZDUM2, ZDUM3, ZDUM4, LLVERBOSE)
...
!$acc      &          PTHT, PRT, PSIGS, PSEA, PTOWN, ZDUM1, ZDUM2, ZDUM3, ZDUM4) &
...
!$acc parallel loop gang vector present (PHYEX) private (YLSTACK, IBL, JLON, D) collapse (2)
  ...
  DO JLON = 1, NPROMA
    ...
    CALL RAIN_ICE (D, PHYEX%CST, PHYEX%PARAM_ICEN, PHYEX%RAIN_ICE_PARAMN, &
                 & PHYEX%RAIN_ICE_DESCRN, PHYEX%ELEC_PARAM, PHYEX%ELEC_DESCR, MISC%TBUCONF, &
                 & PHYEX%PARAM_LIMA, PHYEX%PARAM_LIMA_COLD, PHYEX%PARAM_LIMA_MIXED, &
                 & OELEC=MISC%OELEC, OSEDIM_BEARD=MISC%OSEDIM_BEARD, &
                 & PTHVREFZIKB=ZTHVREFZIKB, PTSTEP=MISC%PTSTEP, &
                 & KRR=MISC%KRR, PEXN=PEXNREF(:,:,IBL),            &
                 ...
                 & PICLDFR=ZDUM1(:, :, IBL), PSSIO=ZDUM2(:, :, IBL), PSSIU=ZDUM3(:, :, IBL), PIFR=ZDUM4(:, :, IBL), &
