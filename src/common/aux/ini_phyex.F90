...
IF(CSCONV=='EDKF') THEN
  IF(IPRINT==2) WRITE(UNIT=KLUOUT,FMT='('' MODD_PARAM_MFSHALL '')')
  IF(LLCHANGEMODEL) CALL PARAM_MFSHALL_GOTO_MODEL(KFROM, KTO)
  IF(PRESENT(PARAM_MFSHALLN_INOUT)) PARAM_MFSHALLN=PARAM_MFSHALLN_INOUT
  ...
  IF(PRESENT(PARAM_MFSHALLN_INOUT)) PARAM_MFSHALLN_INOUT=PARAM_MFSHALLN
ENDIF
