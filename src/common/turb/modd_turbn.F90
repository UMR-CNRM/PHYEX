...
!  REAL, DIMENSION(:,:,:), POINTER :: XWTHVMF=>NULL()! Mass Flux vert. transport of buoyancy
  ...
  LOGICAL            :: LNEWBL89EXP !< .TRUE. to use the bug correction aound the expononent in BL89 length computation
!  
END TYPE TURB_t
...
LOGICAL, POINTER :: LNEWBL89EXP=>NULL()
!
...
LNEWBL89EXP=>TURB_MODEL(KTO)%LNEWBL89EXP
!
ENDIF
!
