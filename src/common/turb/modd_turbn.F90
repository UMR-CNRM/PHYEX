...
NAMELIST/NAM_TURBn/XIMPL,CTURBLEN,CTURBDIM,LTURB_FLX,LTURB_DIAG,  &
                   LSUBG_COND,LSIGMAS,LSIG_CONV,LRMC01,CTOM,CSUBG_AUCV_RC,&
                   XTKEMIN,VSIGQSAT,XCED,XCTP,XCADAP,CSUBG_AUCV_RI,CCONDENS,&
...
CSUBG_AUCV_RC=>TURB_MODEL(KTO)%CSUBG_AUCV_RC
