...
PHYAERO%LSALT         = PHYEX%MISC%LSALT
PHYAERO%NMODE_SLT     = PHYEX%MISC%NMODE_SLT
PHYAERO%XINISIG_SLT   => PHYEX%MISC%XINISIG_SLT
PHYAERO%CRGUNITS      = PHYEX%MISC%CRGUNITS
PHYAERO%XINIRADIUS_SLT=> PHYEX%MISC%XINIRADIUS_SLT
PHYAERO%XDENSITY_SALT = PHYEX%MISC%XDENSITY_SALT
