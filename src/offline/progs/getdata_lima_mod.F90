...
SUBROUTINE GETDATA_LIMA (NPROMA, NGPBLKS, NFLEVG, KRR, KSV, NMOD_CCN, NMOD_IFN, NMOD_IMM, ZTHVREFZIKB, &
                        &PRHODREF_B, PEXNREF_B, PDZZ_B, PRHODJ_B, PPABSM_B, PDTHRAD_B, PTHT_B, &
