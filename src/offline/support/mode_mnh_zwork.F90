...
CONTAINS
  ...
  SUBROUTINE MNH_ALLOCATE_GT1DFLAT(OTAB, KIB, KIE)
    ...
    CALL C_F_POINTER(C_LOC(ZMNH_STACK(YMNH_STACK%L(2) - IOFFSET, IMNH_BLOCK)), OTAB, [KIE - KIB + 1])
    YMNH_STACK%L(2)=YMNH_STACK%L(2)+ISIZE
    IF(YMNH_STACK%L(2)>YMNH_STACK%U(2)) CALL SOF('MNH_ALLOCATE_GT1DFLAT', 0)
  ...
  SUBROUTINE MNH_ALLOCATE_GT2DFLAT(OTAB, KIB, KIE, KJB, KJE)
    ...
    CALL C_F_POINTER(C_LOC(ZMNH_STACK(YMNH_STACK%L(2) - IOFFSET, IMNH_BLOCK)), OTAB, [KIE - KIB + 1, KJE - KJB + 1])
    YMNH_STACK%L(2)=YMNH_STACK%L(2)+ISIZE
    IF(YMNH_STACK%L(2)>YMNH_STACK%U(2)) CALL SOF('MNH_ALLOCATE_GT2DFLAT', 0)
  ...
  SUBROUTINE MNH_ALLOCATE_GT3DFLAT(OTAB, KIB, KIE, KJB, KJE, KKB, KKE)
    ...
    CALL C_F_POINTER(C_LOC(ZMNH_STACK(YMNH_STACK%L(2) - IOFFSET, IMNH_BLOCK)), OTAB, [KIE - KIB + 1, KJE - KJB + 1, KKE - KKB + 1])
    YMNH_STACK%L(2)=YMNH_STACK%L(2)+ISIZE
    IF(YMNH_STACK%L(2)>YMNH_STACK%U(2)) CALL SOF('MNH_ALLOCATE_GT3DFLAT', 0)
  ...
  SUBROUTINE MNH_ALLOCATE_IT1DFLAT(KTAB, KIB, KIE)
    ...
    CALL C_F_POINTER(C_LOC(ZMNH_STACK(YMNH_STACK%L(2) - IOFFSET, IMNH_BLOCK)), KTAB, [KIE - KIB + 1])
    YMNH_STACK%L(2)=YMNH_STACK%L(2)+ISIZE
    IF(YMNH_STACK%L(2)>YMNH_STACK%U(2)) CALL SOF('MNH_ALLOCATE_IT1DFLAT', 0)
  ...
  SUBROUTINE MNH_ALLOCATE_IT2DFLAT(KTAB, KIB, KIE, KJB, KJE)
    ...
    CALL C_F_POINTER(C_LOC(ZMNH_STACK(YMNH_STACK%L(2) - IOFFSET, IMNH_BLOCK)), KTAB, [KIE - KIB + 1, KJE - KJB + 1])
    YMNH_STACK%L(2)=YMNH_STACK%L(2)+ISIZE
    IF(YMNH_STACK%L(2)>YMNH_STACK%U(2)) CALL SOF('MNH_ALLOCATE_IT2DFLAT', 0)
  ...
  SUBROUTINE MNH_ALLOCATE_IT3DFLAT(KTAB, KIB, KIE, KJB, KJE, KKB, KKE)
    ...
    CALL C_F_POINTER(C_LOC(ZMNH_STACK(YMNH_STACK%L(2) - IOFFSET, IMNH_BLOCK)), KTAB, [KIE - KIB + 1, KJE - KJB + 1, KKE - KKB + 1])
    YMNH_STACK%L(2)=YMNH_STACK%L(2)+ISIZE
    IF(YMNH_STACK%L(2)>YMNH_STACK%U(2)) CALL SOF('MNH_ALLOCATE_IT3DFLAT', 0)
  ...
  SUBROUTINE MNH_ALLOCATE_ZT1DFLAT(PTAB, KIB, KIE)
    ...
    PTAB(KIB:KIE) => ZMNH_STACK(YMNH_STACK%L(2):YMNH_STACK%L(2)+ISIZE-1, IMNH_BLOCK)
    YMNH_STACK%L(2)=YMNH_STACK%L(2)+ISIZE
    IF(YMNH_STACK%L(2)>YMNH_STACK%U(2)) CALL SOF('MNH_ALLOCATE_ZT1DFLAT', 0)
  ...
  SUBROUTINE MNH_ALLOCATE_ZT2DFLAT(PTAB, KIB, KIE, KJB, KJE)
    ...
    PTAB(KIB:KIE, KJB:KJE) => ZMNH_STACK(YMNH_STACK%L(2):YMNH_STACK%L(2)+ISIZE-1, IMNH_BLOCK)
    YMNH_STACK%L(2)=YMNH_STACK%L(2)+ISIZE
    IF(YMNH_STACK%L(2)>YMNH_STACK%U(2)) CALL SOF('MNH_ALLOCATE_ZT2DFLAT', 0)
  ...
  SUBROUTINE MNH_ALLOCATE_ZT3DFLAT(PTAB, KIB, KIE, KJB, KJE, KKB, KKE)
    ...
    PTAB(KIB:KIE, KJB:KJE, KKB:KKE) => ZMNH_STACK(YMNH_STACK%L(2):YMNH_STACK%L(2)+ISIZE-1, IMNH_BLOCK)                    
    YMNH_STACK%L(2)=YMNH_STACK%L(2)+ISIZE
    IF(YMNH_STACK%L(2)>YMNH_STACK%U(2)) CALL SOF('MNH_ALLOCATE_ZT3DFLAT', 0)
  ...
  SUBROUTINE MNH_ALLOCATE_ZT4DFLAT(PTAB, KIB, KIE, KJB, KJE, KKB, KKE, KPB, KPE)
    ...
    PTAB(KIB:KIE, KJB:KJE, KKB:KKE, KPB:KPE) => ZMNH_STACK(YMNH_STACK%L(2):YMNH_STACK%L(2)+ISIZE-1, IMNH_BLOCK)
    YMNH_STACK%L(2)=YMNH_STACK%L(2)+ISIZE
    IF(YMNH_STACK%L(2)>YMNH_STACK%U(2)) CALL SOF('MNH_ALLOCATE_ZT4DFLAT', 0)
