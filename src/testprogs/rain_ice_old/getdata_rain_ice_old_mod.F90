...
SUBROUTINE GETDATA_RAIN_ICE_OLD(NPROMA, NGPBLKS, NFLEVG, LLMICRO_B, PEXNREF_B, PDZZ_B, PRHODJ_B,      &
                                PRHODREF_B, PEXNREF2_B, PPABSM_B, PCIT_B, PCLDFR_B, PHLC_HRC_B,       &
                                PHLC_HCF_B, PHLI_HRI_B, PHLI_HCF_B, PTHT_B, PRT_B, PTHS_B, PRS_B,     &
                                PSIGS_B, PSEA_B, PTOWN_B, PCIT_OUT_B, PRS_OUT_B,                      &
                                ZINPRC_B, ZINPRC_OUT_B, PINPRR_B, PINPRR_OUT_B, PEVAP_B, PEVAP_OUT_B, &
                                PINPRS_B, PINPRS_OUT_B, PINPRG_B, PINPRG_OUT_B,                       &
                                ZINDEP_B, ZINDEP_OUT_B, ZRAINFR_B, ZRAINFR_OUT_B,                     &
