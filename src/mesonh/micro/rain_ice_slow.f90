...
use modd_budget,         only: lbudget_th, lbudget_rv, lbudget_rc, lbudget_rr, lbudget_ri, lbudget_rs, lbudget_rg, &
                               ...
                               tbudgets
USE MODD_CST,            only: CST_XALPI => XALPI, CST_XBETAI => XBETAI, CST_XCI => XCI, &
                               CST_XCPV => XCPV, CST_XGAMI => XGAMI, CST_XLSTT => XLSTT, &
                               CST_XMNH_HUGE_12_LOG => XMNH_HUGE_12_LOG, CST_XP00 => XP00, CST_XRV => XRV, CST_XTT => XTT
USE MODD_RAIN_ICE_DESCR_n, only: XRTMIN,&
                                 DESCR_XCEXVT => XCEXVT, DESCR_XBS => XBS, DESCR_XLBDAS_MAX => XLBDAS_MAX, DESCR_XLBS => XLBS, &
                                 DESCR_XLBEXS => XLBEXS, DESCR_XLBG => XLBG, DESCR_XLBEXG => XLBEXG
USE MODD_RAIN_ICE_PARAM_n, only: PARAM_XCRIAUTI => XCRIAUTI,  PARAM_XSCFAC => XSCFAC, PARAM_XALPHA3 => XALPHA3, PARAM_XBETA3 => XBETA3, &
                                 PARAM_XTIMAUTI => XTIMAUTI, PARAM_XTEXAUTI => XTEXAUTI, PARAM_XHON => XHON, &
                                 PARAM_XFIAGGS => XFIAGGS, PARAM_XCOLEXIS => XCOLEXIS, PARAM_XEXIAGGS => XEXIAGGS, &
                                 PARAM_X0DEPS => X0DEPS, PARAM_XEX0DEPS => XEX0DEPS, PARAM_X1DEPS => X1DEPS, PARAM_XEX1DEPS => XEX1DEPS, &
                                 PARAM_XACRIAUTI => XACRIAUTI, PARAM_XBCRIAUTI => XBCRIAUTI, &
...
INTEGER                            :: JL,JLU
!
REAL :: XALPI, XBETAI, XCI, XCPV, XGAMI, XLSTT, XMNH_HUGE_12_LOG, XP00, XRV, XTT
REAL :: XCEXVT, XBS, XLBDAS_MAX, XLBS, XLBEXS, XLBG, XLBEXG
REAL :: XCRIAUTI,  XSCFAC, XALPHA3, XBETA3, XTIMAUTI, XTEXAUTI, XHON, &
        XFIAGGS, XCOLEXIS, XEXIAGGS, X0DEPS, XEX0DEPS, X1DEPS, XEX1DEPS, &
        XACRIAUTI, XBCRIAUTI, X0DEPG, XEX0DEPG, X1DEPG,XEX1DEPG
!
!-------------------------------------------------------------------------------
!
XALPI = CST_XALPI
...
XCEXVT = DESCR_XCEXVT
XBS = DESCR_XBS
XLBDAS_MAX = DESCR_XLBDAS_MAX
XLBS = DESCR_XLBS
XLBEXS = DESCR_XLBEXS
XLBG = DESCR_XLBG
XLBEXG = DESCR_XLBEXG
!
XCRIAUTI = PARAM_XCRIAUTI
XSCFAC = PARAM_XSCFAC
XALPHA3 = PARAM_XALPHA3
XBETA3 = PARAM_XBETA3
XTIMAUTI = PARAM_XTIMAUTI
XTEXAUTI = PARAM_XTEXAUTI
XHON = PARAM_XHON
XFIAGGS = PARAM_XFIAGGS
XCOLEXIS = PARAM_XCOLEXIS
XEXIAGGS = PARAM_XEXIAGGS
X0DEPS = PARAM_X0DEPS
XEX0DEPS = PARAM_XEX0DEPS
X1DEPS = PARAM_X1DEPS
XEX1DEPS = PARAM_XEX1DEPS
XACRIAUTI = PARAM_XACRIAUTI
XBCRIAUTI = PARAM_XBCRIAUTI
X0DEPG = PARAM_X0DEPG
