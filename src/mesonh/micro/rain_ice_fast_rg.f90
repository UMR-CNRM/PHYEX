...
use modd_budget,         only: lbudget_th, lbudget_rc, lbudget_rr, lbudget_ri, lbudget_rs, lbudget_rg, lbudget_rh, &
                               ...
                               tbudgets
USE MODD_CST,            only: CST_XCI => XCI, CST_XCL => XCL, CST_XCPV => XCPV, CST_XESTT => XESTT, &
                               CST_XLMTT => XLMTT, CST_XLVTT => XLVTT, CST_XMD => XMD, CST_XMV => XMV,&
                               CST_XRV => XRV, CST_XTT => XTT
USE MODD_RAIN_ICE_DESCR_n, only: DESCR_XBS  => XBS, DESCR_XCEXVT => XCEXVT, DESCR_XCXG => XCXG, DESCR_XCXS => XCXS, &
                                 DESCR_XDG  => XDG, XRTMIN
USE MODD_RAIN_ICE_PARAM_n, only: PARAM_XEXICFRR => XEXICFRR, PARAM_XEXRCFRI => XEXRCFRI, PARAM_XFRDRYG => XFRDRYG,&
                                 PARAM_XICFRR => XICFRR, XKER_RDRYG, XKER_SDRYG, &
                                 PARAM_XLBRDRYG1 => XLBRDRYG1, PARAM_XLBRDRYG2 => XLBRDRYG2, PARAM_XLBRDRYG3 => XLBRDRYG3, PARAM_XRCFRI => XRCFRI, &
                                 PARAM_XCOLIG => XCOLIG, PARAM_XCOLEXIG => XCOLEXIG,  PARAM_XCOLSG => XCOLSG,PARAM_XCOLEXSG => XCOLEXSG, &
                                 PARAM_X0DEPG => X0DEPG,PARAM_XEX0DEPG => XEX0DEPG, PARAM_X1DEPG => X1DEPG, PARAM_XEX1DEPG => XEX1DEPG, &
                                 PARAM_XFIDRYG => XFIDRYG, PARAM_XFCDRYG => XFCDRYG, &
                                 PARAM_NDRYLBDAG => NDRYLBDAG,PARAM_NDRYLBDAR => NDRYLBDAR,PARAM_NDRYLBDAS => NDRYLBDAS, &
                                 PARAM_XDRYINTP1G => XDRYINTP1G,PARAM_XDRYINTP2G => XDRYINTP2G,PARAM_XDRYINTP2R => XDRYINTP2R,PARAM_XDRYINTP1R => XDRYINTP1R, &
                                 PARAM_XDRYINTP1S => XDRYINTP1S,PARAM_XDRYINTP2S => XDRYINTP2S, &
                                 PARAM_XFSDRYG => XFSDRYG,PARAM_XLBSDRYG1 => XLBSDRYG1,PARAM_XLBSDRYG2 => XLBSDRYG2, PARAM_XLBSDRYG3 => XLBSDRYG3
...
INTEGER                              :: JLU
!
REAL    :: XCI, XCL, XCPV, XESTT, XLMTT, XLVTT, XMD, XMV, XRV, XTT
REAL    :: XBS, XCEXVT, XCXG, XCXS, XDG
REAL    :: XEXICFRR, XEXRCFRI, XFRDRYG, XICFRR, XLBRDRYG1,         &
           XLBRDRYG2, XLBRDRYG3, XRCFRI
REAL    :: XCOLIG,XCOLEXIG, XCOLSG,XCOLEXSG,X0DEPG,XEX0DEPG, &
           X1DEPG,XEX1DEPG,XFIDRYG,XFCDRYG
INTEGER :: NDRYLBDAG,NDRYLBDAR,NDRYLBDAS
REAL    :: XDRYINTP1G,XDRYINTP2G,XDRYINTP2R,XDRYINTP1R, &
           XDRYINTP1S,XDRYINTP2S, &
           XFSDRYG,XLBSDRYG1,XLBSDRYG2, XLBSDRYG3
!
!-------------------------------------------------------------------------------
!
XCI = CST_XCI
...
XDG = DESCR_XDG
!
XEXICFRR = PARAM_XEXICFRR
XEXRCFRI = PARAM_XEXRCFRI
XFRDRYG = PARAM_XFRDRYG
XICFRR = PARAM_XICFRR
XLBRDRYG1 = PARAM_XLBRDRYG1
XLBRDRYG2 = PARAM_XLBRDRYG2
XLBRDRYG3 = PARAM_XLBRDRYG3
XRCFRI = PARAM_XRCFRI
XCOLIG = PARAM_XCOLIG
XCOLEXIG = PARAM_XCOLEXIG
XCOLSG = PARAM_XCOLSG
XCOLEXSG = PARAM_XCOLEXSG
X0DEPG = PARAM_X0DEPG
XEX0DEPG = PARAM_XEX0DEPG
X1DEPG = PARAM_X1DEPG
XEX1DEPG = PARAM_XEX1DEPG
XFIDRYG = PARAM_XFIDRYG
XFCDRYG = PARAM_XFCDRYG
!
NDRYLBDAG = PARAM_NDRYLBDAG
NDRYLBDAR = PARAM_NDRYLBDAR
NDRYLBDAS = PARAM_NDRYLBDAS
!
XDRYINTP1G = PARAM_XDRYINTP1G
XDRYINTP2G = PARAM_XDRYINTP2G
XDRYINTP2R = PARAM_XDRYINTP2R
XDRYINTP1R = PARAM_XDRYINTP1R
XDRYINTP1S = PARAM_XDRYINTP1S
XDRYINTP2S = PARAM_XDRYINTP2S
XFSDRYG = PARAM_XFSDRYG
XLBSDRYG1 = PARAM_XLBSDRYG1
XLBSDRYG2 = PARAM_XLBSDRYG2
XLBSDRYG3 = PARAM_XLBSDRYG3 
!
! IN variables
!
!$acc data present_crm( OMICRO, PRHODREF, PRVT, PRCT, PRRT, PRIT, PRST, PRGT, PCIT,   &
