MODULE MODE_LIMA_PHILLIPS_INTEG_OLD
  IMPLICIT NONE
CONTAINS
!     ######################################################################
  SUBROUTINE LIMA_PHILLIPS_INTEG_OLD (CST, ZZT, ZSI, ZSI0, ZSW, ZZY, Z_FRAC_ACT)
!     ######################################################################
!!
!!    PURPOSE
!!    -------
...
ENDDO
!
END SUBROUTINE LIMA_PHILLIPS_INTEG_OLD
END MODULE MODE_LIMA_PHILLIPS_INTEG_OLD
