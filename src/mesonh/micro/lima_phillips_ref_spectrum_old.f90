MODULE MODE_LIMA_PHILLIPS_REF_SPECTRUM_OLD
  IMPLICIT NONE
CONTAINS
!     ######################################################################
  SUBROUTINE LIMA_PHILLIPS_REF_SPECTRUM_OLD (CST, ZZT, ZSI, ZSI_W, ZZY)
!     ######################################################################
!!
!!    PURPOSE
!!    -------
...
DEALLOCATE(Z2)
!
END SUBROUTINE LIMA_PHILLIPS_REF_SPECTRUM_OLD
END MODULE MODE_LIMA_PHILLIPS_REF_SPECTRUM_OLD
