...
use modd_budget,         only: lbudget_th, lbudget_rc, lbudget_rr, lbudget_rs, lbudget_rg, &
                               ...
                               tbudgets
USE MODD_CST,            only: CST_XCL => XCL, CST_XCPV => XCPV, CST_XESTT => XESTT, &
                               CST_XLMTT => XLMTT, CST_XLVTT => XLVTT, CST_XMD => XMD, CST_XMV => XMV,&
                               CST_XRV => XRV, CST_XTT => XTT
USE MODD_RAIN_ICE_DESCR_n, only: DESCR_XBS  => XBS, DESCR_XCEXVT => XCEXVT, DESCR_XCXS => XCXS, &
                                 XRTMIN
USE MODD_RAIN_ICE_PARAM_n, only: PARAM_NACCLBDAR => NACCLBDAR, PARAM_NACCLBDAS => NACCLBDAS, PARAM_NGAMINC => NGAMINC, &
                                 PARAM_X0DEPS => X0DEPS, PARAM_X1DEPS => X1DEPS,  PARAM_XACCINTP1R => XACCINTP1R, &
                                 PARAM_XACCINTP1S => XACCINTP1S, PARAM_XACCINTP2R => XACCINTP2R, PARAM_XACCINTP2S => XACCINTP2S, &
                                 PARAM_XCRIMSG => XCRIMSG, PARAM_XCRIMSS => XCRIMSS, PARAM_XEX0DEPS => XEX0DEPS, PARAM_XEX1DEPS => XEX1DEPS, &
                                 PARAM_XEXCRIMSG => XEXCRIMSG, PARAM_XEXCRIMSS => XEXCRIMSS, PARAM_XEXSRIMCG => XEXSRIMCG, PARAM_XFRACCSS => XFRACCSS, &
                                 PARAM_XFSACCRG => XFSACCRG, PARAM_XFSCVMG => XFSCVMG, &
                                 XGAMINC_RIM1, XGAMINC_RIM2,XKER_RACCS,XKER_RACCSS,XKER_SACCRG, &
                                 PARAM_XLBRACCS1 => XLBRACCS1, PARAM_XLBRACCS2 => XLBRACCS2, &
                                 PARAM_XLBRACCS3 => XLBRACCS3, PARAM_XLBSACCR1 => XLBSACCR1, PARAM_XLBSACCR2 => XLBSACCR2, PARAM_XLBSACCR3 => XLBSACCR3,    &
                                 PARAM_XRIMINTP1 => XRIMINTP1, PARAM_XRIMINTP2 => XRIMINTP2, PARAM_XSRIMCG => XSRIMCG
...
INTEGER                            :: JJU
!
REAL    :: XCL, XCPV, XESTT, XLMTT, XLVTT, XMD, XMV, XRV, XTT
REAL    :: XBS, XCEXVT, XCXS
INTEGER ::  NACCLBDAR, NACCLBDAS, NGAMINC
REAL    :: X0DEPS, X1DEPS, XACCINTP1R, XACCINTP1S, XACCINTP2R, XACCINTP2S, &
           XCRIMSG, XCRIMSS, XEX0DEPS, XEX1DEPS, XEXCRIMSG, XEXCRIMSS, XEXSRIMCG, XFRACCSS,               &
           XFSACCRG, XFSCVMG, &
           XLBRACCS1, XLBRACCS2, XLBRACCS3, XLBSACCR1, XLBSACCR2, XLBSACCR3,    &
...
XCXS = DESCR_XCXS
!
NACCLBDAR = PARAM_NACCLBDAR
NACCLBDAS = PARAM_NACCLBDAS
NGAMINC = PARAM_NGAMINC
X0DEPS = PARAM_X0DEPS
X1DEPS = PARAM_X1DEPS
XACCINTP1R = PARAM_XACCINTP1R
XACCINTP1S = PARAM_XACCINTP1S
XACCINTP2R = PARAM_XACCINTP2R
XACCINTP2S = PARAM_XACCINTP2S
XCRIMSG = PARAM_XCRIMSG
XCRIMSS = PARAM_XCRIMSS
XEX0DEPS = PARAM_XEX0DEPS
XEX1DEPS = PARAM_XEX1DEPS
XEXCRIMSG = PARAM_XEXCRIMSG
XEXCRIMSS = PARAM_XEXCRIMSS
XEXSRIMCG = PARAM_XEXSRIMCG
XFRACCSS = PARAM_XFRACCSS
XFSACCRG = PARAM_XFSACCRG
XFSCVMG = PARAM_XFSCVMG
XLBRACCS1 = PARAM_XLBRACCS1
XLBRACCS2 = PARAM_XLBRACCS2
XLBRACCS3 = PARAM_XLBRACCS3
XLBSACCR1 = PARAM_XLBSACCR1
XLBSACCR2 = PARAM_XLBSACCR2
XLBSACCR3 = PARAM_XLBSACCR3    
XRIMINTP1 = PARAM_XRIMINTP1
XRIMINTP2 = PARAM_XRIMINTP2
XSRIMCG = PARAM_XSRIMCG
!
! IN variables
!
!
