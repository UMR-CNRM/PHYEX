...
! Atmospheric case   
  ZEXNSURF=(ZPGROUND/XP00)**(XRD/XCPD)
  CALL FILL_DIMPHYEX(YLDIMPHYEX, IKU, 1, 1, .TRUE.) !vertical dim set as horizontal dim
  DO JLOOP=1,20 ! loop for pression 
    ...
    CALL TH_R_FROM_THL_RT(YLDIMPHYEX,CST,NEBN,'T',ZFRAC_ICE,ZPRESS,ZTHLM,ZMRT,ZTHM,ZMRM,ZMRCM,ZMRIM, &
