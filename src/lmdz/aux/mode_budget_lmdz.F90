MODULE MODE_BUDGET_LMDZ
!
USE MODD_BUDGET, ONLY: TBUDGETDATA
!
IMPLICIT NONE
!
TYPE, EXTENDS(TBUDGETDATA) :: TBUDGETDATA_LMDZ
  CONTAINS
  PROCEDURE :: INIT_PHY => BUDGET_INIT
  PROCEDURE :: END_PHY => BUDGET_END
  PROCEDURE :: ADD_PHY => BUDGET_ADD
ENDTYPE TBUDGETDATA_LMDZ
!
PRIVATE
PUBLIC :: TBUDGETDATA_LMDZ
!
CONTAINS
!
SUBROUTINE BUDGET_INIT(SELF, D, HSOURCE, PVARS)
  USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
  CLASS(TBUDGETDATA_LMDZ),       INTENT(INOUT) :: SELF
