!     ######spl
      SUBROUTINE  ARO_ADJUST(CST, PARAM_ICEN, RAIN_ICE_PARAMN, TURBN, &
...
!
IF (KRR==6) THEN
  CALL ICE_ADJUST ( YLDIMPHYEX, CST=CST, ICEP=RAIN_ICE_PARAMN, NEB=NEB, TURBN=TURBN, BUCONF=TBUCONF, KRR=KRR,&
