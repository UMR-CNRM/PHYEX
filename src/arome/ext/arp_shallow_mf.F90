...
REAL, DIMENSION(KIDIA:KFDIA,KLEV+2)  ::  ZHLC_HRC_MF, ZHLC_HCF_MF, ZHLI_HRI_MF, ZHLI_HCF_MF
REAL, DIMENSION(KIDIA:KFDIA,KLEV+2)  ::  ZWEIGHT_MF_CLOUD
...
!
!         ---------------------------------
  CALL SHALLOW_MF(YLDIMPHYEX, CST, NEBN, PARAM_MFSHALLN, TURBN, CSTURB, RAIN_ICE_PARAMN,  &
...
!  Output
      ...
      PSIGMF=ZSIGMF,PRC_MF=ZRC_MF,PRI_MF=ZRI_MF,PCF_MF=ZCF_MF,                  &
