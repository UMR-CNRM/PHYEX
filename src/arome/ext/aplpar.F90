...
ASSOCIATE(CMF_UPDRAFT=>YDPARAR%PARAM_MFSHALLN%CMF_UPDRAFT, TSPHY=>YDPHY2%TSPHY, NTSSG=>YDDPHY%NTSSG, LMDUST=>YDARPHY%LMDUST,              &
...
& LADJCLD=>YDPHY%LADJCLD, LGRAPRO=>YDPHY%LGRAPRO, RDECLI=>YDRIP%RDECLI, CMF_CLOUD=>YDPARAR%PARAM_MFSHALLN%CMF_CLOUD,                      &
& XSW_BANDS=>YDPARAR%XSW_BANDS, NSWB_MNH=>YDPARAR%NSWB_MNH, LMIXUV=>YDPARAR%PARAM_MFSHALLN%LMIXUV, NTRADI=>YDTOPH%NTRADI,                 &
