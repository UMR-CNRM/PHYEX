...
ASSOCIATE(XLINI=>YDPARAR%XLINI, &
 & NSPLITR=>YDPARAR%NSPLITR, NSPLITG=>YDPARAR%NSPLITG, &
 & CMICRO=>YDPARAR%CMICRO, NSV=>YDPARAR%NSV, &
 & LAROBU_ENABLE=>YDPARAR%LAROBU_ENABLE, &
 & NRR=>YDPARAR%NRR, LHARATU=>YDPARAR%LHARATU, LOSUBG_COND=>YDPARAR%LOSUBG_COND,&
 ...
 & CST=>YDPARAR%CST, PARAM_ICE=>YDPARAR%PARAM_ICE, RAIN_ICE_DESCR=>YDPARAR%RAIN_ICE_DESCR, &
 & RAIN_ICE_PARAM=>YDPARAR%RAIN_ICE_PARAM, CLOUDPARN=>YDPARAR%CLOUDPARN, &
 & PARAM_MFSHALLN=>YDPARAR%PARAM_MFSHALLN)
!     ------------------------------------------------------------------
!     ------------------------------------------------------------------
...
CALL INI_PHYEX(CPROGRAM, NULNAM, .TRUE., KULOUT, 0, 1, &
               ...
               PARAM_MFSHALLN_INOUT=PARAM_MFSHALLN)
...
IF (LHARATU .AND. PARAM_MFSHALLN%CMF_UPDRAFT == 'EDKF') THEN
