...
CALL INI_PHYEX(CPROGRAM, NULNAM, .TRUE., KULOUT, 0, 1, &
               ...
               KPRINT=2, &
               CST_OUT=CST, &
               PARAM_ICE_OUT=PARAM_ICE, RAIN_ICE_DESCR_OUT=RAIN_ICE_DESCR, &
               RAIN_ICE_PARAM_OUT=RAIN_ICE_PARAM, CLOUDPARN_OUT=CLOUDPARN, &
...
IF (TURBN%LHARAT .AND. PARAM_MFSHALLN%CMF_UPDRAFT == 'EDKF') THEN
