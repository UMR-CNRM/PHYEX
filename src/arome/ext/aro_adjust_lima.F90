...
PSVS = PSVS * 2.*PTSTEP
IF (LLIMAINIT) THEN
   CALL SET_CONC_LIMA (YLDIMPHYEX,KRR,1,'ICE3',PRHODREF,PRT,PSVT)
   CALL SET_CONC_LIMA (YLDIMPHYEX,KRR,1,'ICE3',PRHODREF,PRS,PSVS)
ELSE
   CALL SET_CONC_LIMA (YLDIMPHYEX,KRR,1,'ICE3',PRHODREF,PRT,PSVT, .TRUE.)
   CALL SET_CONC_LIMA (YLDIMPHYEX,KRR,1,'ICE3',PRHODREF,PRS,PSVS, .TRUE.)
END IF
PRS = PRS / (2.*PTSTEP)
PSVS = PSVS / (2.*PTSTEP)
