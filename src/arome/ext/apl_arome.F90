...
& LOSIGMAS=>YDPARAR%LOSIGMAS, NRR=>YDPARAR%NRR, LOSUBG_COND=>YDPARAR%LOSUBG_COND,       &
& RADGR=>YDPARAR%RADGR, LHARATU=>YDPARAR%LHARATU, XMINLM=>YDPHY0%XMINLM,                            &
...
IF (LMICRO) THEN
  ...
  IF (MOD(YDCPG_OPTS%KSTEP+1,NPRINTFR)==0) THEN
    ...
    WRITE(NULOUT,*)'NRR and co',NRR,YDCPG_OPTS%KSTEP+1,NSPLITR,LOSUBG_COND, LOSIGMAS, CSUBG_AUCV_RC
  ENDIF
