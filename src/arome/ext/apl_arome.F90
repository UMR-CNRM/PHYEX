...
IF (LMICRO) THEN
  ...
  ELSE
    ...
    CALL ARO_ADJUST (CST, PARAM_ICE, RAIN_ICE_PARAM, TURBN, &
...
IF (LMFSHAL) THEN
  IF (PARAM_MFSHALLN%CMF_UPDRAFT=='DUAL') THEN
    ...
    IF (PARAM_ICE%LOCND2.AND.LMICRO.AND.CMICRO/='LIMA') THEN
      DO JLEV=1,YDCPG_OPTS%KFLEVG
  ...
  DO JDRAFT=IDRAFT,3
    ...
    CALL ARO_SHALLOW_MF (CST, PARAM_ICE, PARAM_MFSHALLN,                                                                          &
...
IF (LMICRO) THEN
  ...
  IF (CMICRO == 'LIMA') THEN
    ...
    &              )
  ELSE
    CALL ARO_RAIN_ICE (CST, PARAM_ICE, RAIN_ICE_PARAM, RAIN_ICE_DESCR, CLOUDPARN, TURBN, &
