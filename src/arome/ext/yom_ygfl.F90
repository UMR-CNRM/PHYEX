...
TYPE(TYPE_GFL_COMP),POINTER  :: YWMFC       => NULL() ! Weight of the Mass-Flux cloud
TYPE(TYPE_GFL_COMP),POINTER  :: YHLMF       => NULL() ! High liquid content due to Mass-Flux
TYPE(TYPE_GFL_COMP),POINTER  :: YHLCFMF     => NULL() ! High liquid cloud fraction due to Mass-Flux
TYPE(TYPE_GFL_COMP),POINTER  :: YHIMF       => NULL() ! High ice content due to Mass-Flux
TYPE(TYPE_GFL_COMP),POINTER  :: YHICFMF     => NULL() ! High ice cloud fraction due to Mass-Flux
...
TYPE(TYPE_GFL_NAML)  :: YWMFC_NL              ! Weight of the Mass-Flux cloud
TYPE(TYPE_GFL_NAML)  :: YHLMF_NL              ! High liquid content due to Mass-Flux
TYPE(TYPE_GFL_NAML)  :: YHLCFMF_NL            ! High liquid cloud fraction due to Mass-Flux
TYPE(TYPE_GFL_NAML)  :: YHIMF_NL              ! High ice content due to Mass-Flux
TYPE(TYPE_GFL_NAML)  :: YHICFMF_NL            ! High ice cloud fraction due to Mass-Flux
